...
use App\Http\Controllers\admin\SocialProofController;
...
Route::middleware('throttle:limit-check')->group(function (){
    ...
    Route::prefix('admin/secured')->middleware('admin')->group(function () {
        ...
        Route::get('social-proof', [SocialProofController::class, 'index'])->name('admin.social-proof.index');
        Route::post('social-proof/status/{id}', [SocialProofController::class, 'updateStatus'])->name('admin.social-proof.status');
  ...
  Route::get('/myp', [UserController::class, 'myp'])->name('myp');
        //invite
        ...
        Route::post('/appreview', [UserController::class, 'appreview_submit'])->name('appreview.submit');
        ...
        Route::get('teach', function(){return view('app.main.teach');})->name('teach');
        Route::get('paper', function(){return view('app.main.paper');})->name('paper');
        Route::get('cert', function(){return view('app.main.cert');})->name('cert');
  Route::get('help', function(){return view('app.main.help');})->name('help');
Route::get('feed', function(){return view('app.main.feed');})->name('feed');
Route::get('terms', function(){return view('app.main.terms');})->name('terms');
