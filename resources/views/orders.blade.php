    ...
    $(document).ready(function() 
{
    ...
    <div class="loader" id="preloader">
        ...
        <div class="loader"><img src="{{asset ('1.gif')}}" alt="" style="height: 80; width: 80px;">
        </div>
    </div>
    <!-- end loader -->
