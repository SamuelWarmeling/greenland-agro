                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="tab">Tipo de plano</label>
                                        <select name="tab" id="tab" class="form-control is-valid">
                                            <option value="">Select a option</option>
                                            <option value="vip" @if($data && $data->tab == 'vip') selected @endif>Plano base (ativacao)</option>
                                            <option value="fixed" @if($data && $data->tab == 'fixed') selected @endif>Ciclo VIP</option>
                                            <option value="event" @if($data && $data->tab == 'event') selected @endif>Evento relampago</option>
                                        </select>
                                        <div class="valid-feedback">
                                            <i class="bx bx-radio-circle"></i>
                                            Note: This is filed is required
                                    ...
                                    <div class="col-sm-6">
                                        <label for="label">Nivel / etiqueta</label>
                                        <input type="text" class="form-control is-valid"
                                               name="label" id="label"
                                               placeholder="Ex.: VIP 1" value="{{$data ? $data->label : ''}}" required>
                                        <div class="valid-feedback">
                                            <i class="bx bx-radio-circle"></i>
                                            Note: This is filed is required
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <label for="price">Valor de entrada</label>
                                    ...
                                    <div class="col-sm-6">
                                        <label for="validity">Duracao do ciclo (dias)</label>
                                        <input type="number" class="form-control is-valid"
                                    ...
                                    <div class="col-sm-6">
                                        <label for="commission_with_avg_amount">Retorno total previsto</label>
                                        <input type="number" class="form-control is-valid"
                                        ...
                                        <div class="col-sm-6">
                                            <label for="ref1">Comissao nivel 1 (%)</label>
                                            <input type="text" class="form-control is-valid"
                                                   name="ref1" id="ref1"
                                        ...
                                        <div class="col-sm-6">
                                            <label for="ref2">Comissao nivel 2 (%)</label>
                                            <input type="text" class="form-control is-valid"
                                                   name="ref2" id="ref2"
                                        ...
                                        <div class="col-sm-6">
                                            <label for="ref3">Comissao nivel 3 (%)</label>
                                            <input type="text" class="form-control is-valid"
                                                   name="ref3" id="ref3"
