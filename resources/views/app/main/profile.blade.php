...
<head>
    ...
    <style type="text/css">
        ...
        .loader-outter {
            ...
            width: 100%;
            height: 100%;
            -webkit-animation: loader-outter 1s #f79102;
            animation: loader-outter 1s #f79102 ;
        }
    ...
    <style type="text/css">
        ...
        .bg-item {
            border-radius: .32rem;
            border: 0.02rem solid rgb(26 26 26);
            background: #fff;
  ...
  */
    ...
    <style type="text/css">
        .card-con[data-v-0cd9ae3e] {
            ...
            margin: .4rem 0 .54rem;
            display: flex;
            background: url({{asset ('star/profile/static/img/invitebg.cdfe3b13.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .home-video[data-v-bda0bfee] {
            ...
            background: url({{asset ('star/profile/static/img/bg-video.9e4c14b7.png')}}) no-repeat;
            background-size: 100% 100%;
            position: relative;
        }
    ...
    <style type="text/css">
        .market-item[data-v-4d062292] {
            width: calc(48%);
            padding: .32rem .28rem;
            background: url({{asset ('star/profile/static/img/bg-market-item.ade5668a.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .bg[data-v-5954443c] {
            background: #000 url({{asset ('star/profile/static/img/bg-home.a6c7beab.png')}}) no-repeat;
        ...
        .home-introduce .introduce-info[data-v-5954443c] {
            flex: 1;
            padding: .36rem .32rem;
            background: url({{asset ('star/profile/static/img/jieshaobg.663a51d7.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
        ...
        .home-notice[data-v-5954443c] {
            position: relative;
            margin-top: 0.19802rem;
            background: url({{asset ('star/profile/static/img/linebg.eec555f4.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
        ...
        .name-1 .tab .active[data-v-5954443c] {
            background: url({{asset ('star/profile/static/img/tabbg.28cb0f3a.png')}}) center no-repeat;
            background-size: 100% 100%;
            color: #fff;
        }
        ...
        .itemBox2[data-v-5954443c] {
            ...
            background: url({{asset ('star/profile/static/img/partnerbg.9e4c14b7.png')}}) center no-repeat;
            background-size: 100% 100%;
            margin-bottom: 0.4rem;
            color: #ffffff;
        }
    ...
    <style type="text/css">
        ...
        .level-box[data-v-55daada6] {
            background: url({{asset ('star/profile/static/img/bg-level.48bb2282.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            display: flex;
        }
    ...
    <style type="text/css">
        ...
        .total-income[data-v-f8277c96] {
            margin-top: .2rem;
            overflow: hidden;
            background: url({{asset ('star/profile/static/img/bg-chart.aa2ec508.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .wallet-assets .assets-list[data-v-8bfe4f4e] {
            ...
            flex-wrap: wrap;
            padding: .32rem 0;
            background: url({{asset ('star/profile/static/img/bg-wallet-assets.e9aa4a59.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .income_box[data-v-14275b54] {
            padding: .28rem;
            background: url({{asset ('star/profile/static/img/home-wallet-bg.8a119ff6.png')}}) no-repeat top center;
            background-size: 100% 100%;
            border-radius: .16rem;
        }
    ...
    <style type="text/css">
        .grid-banner[data-v-5f02d15c] {
            ...
            align-items: center;
            line-height: 1.2;
            background: url({{asset ('star/profile/static/img/bg-banner.66e8bfef.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .grid-info .level-con[data-v-a156a844] {
            ...
            justify-content: center;
            flex-direction: column;
            background: url({{asset ('star/profile/static/img/bg-grid-info-left.9ab0bdb4.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: .24rem .32rem;
        }
        ...
        .grid-info .info-right[data-v-a156a844] {
            ...
            padding: .28rem;
            text-align: center;
            background: url({{asset ('star/profile/static/img/bg-grid-info-right.a37bece4.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        [data-v-e157743a] .headers {
            background: url({{asset ('star/profile/static/img/bg-home.a6c7beab.png')}}) no-repeat top center !important;
    ...
    <style type="text/css">
        ...
        .grid-trad .trad-left[data-v-ea03dd80] {
            ...
            justify-content: center;
            flex-direction: column;
            background: url({{asset ('star/profile/static/img/bg-trad-left.975f1e9d.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: .24rem .32rem;
        }
        ...
        .grid-trad .trad-right .grid-btn[data-v-ea03dd80] {
            ...
            font-size: .24rem;
            padding: 0.07921rem;
            background: url({{asset ('star/profile/static/img/bg-grid-btn.dc03b59b.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    </style>
    <style type="text/css">
        .grid-level[data-v-481208f5] {
            ...
            background: url({{asset ('star/profile/static/img/bg-grid-card.f68af2cd.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .popup-box .content .grid-level-list .grid-level-item.active[data-v-d0256664] {
            border: none;
            background: url({{asset ('star/profile/static/img/bg-grid-level-active.3f9197b3.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .assets-list[data-v-0549ce35] {
            ...
            flex-wrap: wrap;
            padding: 0.4rem;
            background: url({{asset ('star/profile/static/img/bg-assets.786bee5d.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .quantify-level[data-v-15212f42] {
            ...
            background: url({{asset ('star/profile/static/img/bg-quantify-level.3c28e742.png')}}) no-repeat;
            background-size: 100% 100%;
            display: flex;
            align-items: center;
            justify-content: space-between;
    ...
    <style type="text/css">
        ...
        .trading-btn[data-v-4681035b] {
            ...
            align-items: center;
            justify-content: center;
            background: url({{asset ('star/profile/static/img/bg-btn.43aa1b59.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            font-size: 0.32rem;
            text-align: center;
    ...
    <style type="text/css">
        .assets-list[data-v-38c37e3e] {
            padding: .4rem .28rem;
            background: url({{asset ('star/profile/static/img/bg-asstes-card.ce8df5cb.png')}}) no-repeat;
            background-size: 100% 100%;
            display: flex;
            align-items: center;
            flex-wrap: wrap;
    ...
    <style type="text/css">
        ...
        .my-navs .nav[data-v-1f0d3d2c] {
            ...
            display: flex;
            flex-direction: column;
            background: url({{asset ('star/profile/static/img/20260126_000502.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: .4rem .32rem;
        }
    ...
    <style type="text/css">
        ...
        .g1[data-v-7a3d5949] {
            background: url({{asset ('star/profile/static/img/20250406_150255.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #000;
            margin-top: 0.32rem;
        }
    ...
    <style type="text/css">
        ...
        .bg[data-v-2a224bbc] {
            background: #000 url({{asset ('star/profile/static/img/bg_invite.10776553.png')}}) no-repeat;
            background-size: 100% auto;
            width: 100%;
            height: 100%;
        }
        ...
        .invite-con[data-v-2a224bbc] {
            ...
            background: url({{asset ('star/profile/static/img/bg-invite-con.0a4a121d.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: 0 .32rem;
        }
        ...
        .invite-con .qrcode-box .qrcode-con[data-v-2a224bbc] {
            width: fit-content;
            padding: .32rem;
            background: url({{asset ('star/profile/static/img/bg-qrcode.79d104a8.png')}}) no-repeat;
            background-size: 100% 100%;
        }
...
<body __processed_45a1e1de-c144-4026-9a7f-7c194fe791c6__="true"
    ...
    <div id="app" class="applang" bis_skin_checked="1">
        <div data-v-37526a6c="" data-v-7a3d5949="" class="page" bis_skin_checked="1">
            <div data-v-7a3d5949="" data-v-37526a6c="" class="bg" bis_skin_checked="1"></div>
            <div data-v-37526a6c="" class="headers" bis_skin_checked="1">
                <div data-v-7a3d5949="" data-v-37526a6c="" class="heads" bis_skin_checked="1">
                    <div data-v-7a3d5949="" data-v-37526a6c="" class="container flex" bis_skin_checked="1">
                        <div data-v-7a3d5949="" data-v-37526a6c="" class="flex1" bis_skin_checked="1"> Mine </div>
                        <div data-v-7a3d5949="" data-v-37526a6c="" class="notice" bis_skin_checked="1">
                            <img data-v-7a3d5949="" data-v-37526a6c="" src="/star/dash/upload/v1/20260124_170318.png" alt=""><span data-v-7a3d5949="" data-v-37526a6c=""> 2 </span>
                        </div>
                    </div>
                </div>
            </div>
            <div data-v-37526a6c="" id="scroll" class="content-container" bis_skin_checked="1"
                style="padding-top: 55px; padding-bottom: 62px;">
                <div data-v-37526a6c="" id="content" class="content-scroll" bis_skin_checked="1">
                    <div data-v-7a3d5949="" data-v-37526a6c="" class="container" bis_skin_checked="1">
                        <div data-v-5eb5f75c="" data-v-7a3d5949="" class="my-head" data-v-37526a6c=""
                            bis_skin_checked="1">
                            <div data-v-5eb5f75c="" class="avatar" bis_skin_checked="1"><img data-v-5eb5f75c="" src="/v1/20260126_082332.jpg" alt="">
                            </div>
                            <div data-v-5eb5f75c="" class="nickname" bis_skin_checked="1">balance {{currency()}}{{(auth()->user()->balance)}}</div>
                            <div data-v-5eb5f75c="" class="code-box" bis_skin_checked="1">
                                <span data-v-5eb5f75c="" class="text">Invitation code:</span><span data-v-5eb5f75c="" class="code">{{('').''.auth()->user()->ref_id}}</span><span data-v-5eb5f75c=""></span>
                            </div>
                            <div data-v-5eb5f75c="" class="code-box" bis_skin_checked="1">
                                <span data-v-5eb5f75c="" class="text">UID:</span><span data-v-5eb5f75c="" class="code">{{user()->phone}}</span><span data-v-5eb5f75c=""></span>
                            </div>
                        </div>
                        <div >
                            <div >
                        ...
                        <div data-v-1f0d3d2c="" data-v-7a3d5949="" class="my-navs" data-v-37526a6c=""
                            bis_skin_checked="1">
                            <div data-v-1f0d3d2c="" class="nav" bis_skin_checked="1" onclick="window.location.href='{{route ('user.bank.create')}}'">
                                <div data-v-1f0d3d2c="" class="nav-head" bis_skin_checked="1">
                                    <img data-v-1f0d3d2c="" src="/v1/20260126_081916.png" alt="" class="icon"><img data-v-1f0d3d2c="" src="data:image/png;base64," alt="" class="arrow">
                                </div>
                                <div data-v-1f0d3d2c="" class="name" bis_skin_checked="1">Ad Wallet</div>
                            </div>
                            <div data-v-1f0d3d2c="" class="nav" bis_skin_checked="1"onclick="window.location.href='{{route ('exchange')}}'" >
                                <div data-v-1f0d3d2c="" class="nav-head" bis_skin_checked="1">
                                    <img data-v-1f0d3d2c="" src="/v1/20260126_081828.png" alt="" class="icon"><img data-v-1f0d3d2c="" src="data:image/png;base64," alt="" class="arrow">
                                </div>
                                <div data-v-1f0d3d2c="" class="name" bis_skin_checked="1">Treasure box</div>
                            </div>
                            <div >
                            </div>
                            <div >
                    ...
                    <div data-v-7a3d5949="" data-v-37526a6c="" class="container" bis_skin_checked="1">
                        <div data-v-7a3d5949="" data-v-37526a6c="" class="line" bis_skin_checked="1">
                            <div data-v-7a3d5949="" data-v-37526a6c="" class="module" bis_skin_checked="1">
                                <div data-v-7a3d5949="" data-v-37526a6c="" class="module-title" bis_skin_checked="1">
                                    Common functions</div>
                                <ul data-v-7a3d5949="" data-v-37526a6c="">
                                    <li data-v-7a3d5949="" data-v-37526a6c="" class="db" onclick="window.location.href='{{route ('terms')}}'">
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="ico" bis_skin_checked="1"><img data-v-7a3d5949="" data-v-37526a6c="" src="/v1/contract-3d-illustration-png.png" alt="">
                                        </div>
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="flexs" bis_skin_checked="1">
                                            Terms of use</div>
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="status" bis_skin_checked="1">
                                            <!---->
                                            <!---->
                                            <!---->
                                            <!---->
                                        </div>
                                        <i data-v-7a3d5949="" data-v-37526a6c="" class="arrow van-icon van-icon-arrow"><!----></i>
                                    </li>
                                    <li data-v-7a3d5949="" data-v-37526a6c="" class="db" onclick="window.location.href='{{route ('cert')}}'">
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="ico" bis_skin_checked="1"><img data-v-7a3d5949="" data-v-37526a6c="" src="/v1/3d-icon-certificate-for-education-png.png" alt="">
                                        </div>
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="flexs" bis_skin_checked="1">
                                            Official certification</div>
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="status" bis_skin_checked="1">
                                            <!---->
                                            <!---->
                                            <!---->
                                    ...
                                    <li data-v-7a3d5949="" data-v-37526a6c="" class="db" onclick="window.location.href='{{route ('user.change.password')}}'">
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="ico" bis_skin_checked="1"><img data-v-7a3d5949="" data-v-37526a6c="" src="/v1/stylized-3d-password-page-illustration-free-png.png" alt="">
                                        </div>
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="flexs" bis_skin_checked="1">
                                          User  Password</div>
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="status" bis_skin_checked="1">
                                            <span data-v-7a3d5949="" data-v-37526a6c="" class="s1"></span>
                                            <!---->
                                            <!---->
                                            <!---->
                                        </div>
                                    ...
                                    <li data-v-7a3d5949="" data-v-37526a6c="" class="db" onclick="window.location.href='{{route('user.change.password')}}'">
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="ico" bis_skin_checked="1"><img data-v-7a3d5949="" data-v-37526a6c="" src="/v1/cashless-payment-shopping-financial-credit-card-3d-icon-png.png" alt="">
                                        </div>
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="flexs" bis_skin_checked="1">
                            ...
                            <div data-v-7a3d5949="" data-v-37526a6c="" class="module" bis_skin_checked="1">
                                ...
                                <ul data-v-7a3d5949="" data-v-37526a6c="">
                                    ...
                                    <li data-v-7a3d5949="" data-v-37526a6c="" class="db" onclick="window.location.href='{{route ('help')}}'">
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="ico" bis_skin_checked="1"><img data-v-7a3d5949="" data-v-37526a6c="" src="/v1/3d-chat-chatting-icon-png.png" alt="">
                                        </div>
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="flexs" bis_skin_checked="1">
                                            Help center</div>
                                        <i data-v-7a3d5949="" data-v-37526a6c="" class="arrow van-icon van-icon-arrow"><!----></i>
                                    ...
                                    <li data-v-7a3d5949="" data-v-37526a6c="" class="db" onclick="window.location.href='{{route ('user.service')}}'">
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="ico" bis_skin_checked="1"><img data-v-7a3d5949="" data-v-37526a6c="" src="/v1/consultation-help-care-png.png" alt="">
                                        </div>
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="flexs" bis_skin_checked="1">
                                            Contact customer service</div>
                                        <i data-v-7a3d5949="" data-v-37526a6c="" class="arrow van-icon van-icon-arrow"><!----></i>
                                    </li>
                                    <li data-v-7a3d5949="" data-v-37526a6c="" class="db" onclick="window.location.href='{{route ('profile')}}'">
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="ico" bis_skin_checked="1"><img data-v-7a3d5949="" data-v-37526a6c="" src="/v1/empty-trash-3d-icon-png.png" alt="">
                                        </div>
                                        <div data-v-7a3d5949="" data-v-37526a6c="" class="flexs" bis_skin_checked="1">
                                            Clear cache</div>
                                        <i data-v-7a3d5949="" data-v-37526a6c="" class="arrow van-icon van-icon-arrow"><!----></i>
                        ...
                        <div data-v-7a3d5949="" data-v-37526a6c="" class="btn-list" bis_skin_checked="1">
                            <div data-v-7a3d5949="" onclick="window.location.href='{{route ('logout')}}'"  data-v-37526a6c="" class="btn-quit" bis_skin_checked="1">Sign out
                            </div>
                            <div data-v-7a3d5949=""  onclick="window.location.href='https://t.me/'" data-v-37526a6c="" class="btn-delete bg-item" bis_skin_checked="1">
                               Request Delete account </div>
                        </div>
                    </div>
                </div>
            </div>
           <div data-v-37526a6c="" class="footer" bis_skin_checked="1">
                <div data-v-6c4d8baa="" data-v-5954443c="" class="footers" id="footer" data-v-37526a6c=""
                    bis_skin_checked="1">
                    <div data-v-6c4d8baa="" class="item" bis_skin_checked="1" onclick="window.location.href='{{route ('dashboard')}}'">
                        <div data-v-6c4d8baa="" class="on" bis_skin_checked="1">
                            <img data-v-6c4d8baa="" src="{{asset ('star/dash/upload/v1/20250724_022856.png')}}" alt=""><span data-v-6c4d8baa="">Home</span>
                        </div>
                    </div>
                    <div data-v-6c4d8baa="" class="item" bis_skin_checked="1" onclick="window.location.href='{{route ('ordered')}}'">
                        <div data-v-6c4d8baa="" class="" bis_skin_checked="1">
                            <img data-v-6c4d8baa="" src="{{asset ('star/dash/upload/v1/20250724_023739.png')}}" alt=""><span data-v-6c4d8baa="">Assets</span>
                        </div>
                    </div>
                    <div data-v-6c4d8baa="" class="item" bis_skin_checked="1" onclick="window.location.href='{{route ('vip')}}'">
                        <div data-v-6c4d8baa="" class="" bis_skin_checked="1"><img data-v-6c4d8baa="" src="{{asset ('star/dash/upload/v1/20250724_033641.png')}}" alt="">
                            <!---->
                        </div>
                    </div>
                    <div data-v-6c4d8baa="" class="item" bis_skin_checked="1" onclick="window.location.href='{{route ('user.team')}}'">
                        <div data-v-6c4d8baa="" class="" bis_skin_checked="1">
                            <img data-v-6c4d8baa="" src="{{asset ('star/dash/upload/v1/20250724_023117.png')}}" alt=""><span data-v-6c4d8baa="">Team</span>
                        </div>
                    </div>
                    <div data-v-6c4d8baa="" class="item" bis_skin_checked="1" onclick="window.location.href='{{route ('profile')}}'">
                        <div data-v-6c4d8baa="" class="" bis_skin_checked="1">
                            <img data-v-6c4d8baa="" src="{{asset ('star/dash/upload/v1/20260124_163129.png')}}" alt=""><span data-v-6c4d8baa="">Mine</span>
                        </div>
                    </div>
                </div>
            </div>
