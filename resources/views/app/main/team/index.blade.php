  ...
  */
    ...
    <style type="text/css">
        ...
        .popup_box .popup-content-head[data-v-75ed67aa] {
            ...
            width: 100%;
            height: 2.6rem;
            background-image: url({{asset ('star/team/static/img/home_popup_top_bg.8bed63d3.png')}});
            background-size: 100% 100%;
            background-repeat: no-repeat;
    ...
    <style type="text/css">
        .card-con[data-v-0cd9ae3e] {
            ...
            margin: .4rem 0 .54rem;
            display: flex;
            background: url({{asset ('star/team/static/img/invitebg.cdfe3b13.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .home-video[data-v-bda0bfee] {
            ...
            background: url({{asset ('star/team/static/img/bg-video.9e4c14b7.png')}}) no-repeat;
            background-size: 100% 100%;
            position: relative;
        }
    ...
    <style type="text/css">
        .market-item[data-v-4d062292] {
            width: calc(48%);
            padding: .32rem .28rem;
            background: url({{asset ('star/team/static/img/bg-market-item.ade5668a.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .bg[data-v-5954443c] {
            background: #000 url({{asset ('star/team/static/img/bg-home.a6c7beab.png')}}) no-repeat;
        ...
        .home-introduce .introduce-info[data-v-5954443c] {
            flex: 1;
            padding: .36rem .32rem;
            background: url({{asset ('star/team/static/img/jieshaobg.663a51d7.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
        ...
        .home-notice[data-v-5954443c] {
            position: relative;
            margin-top: 0.19802rem;
            background: url({{asset ('star/team/static/img/linebg.eec555f4.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
        ...
        .name-1 .tab .active[data-v-5954443c] {
            background: url({{asset ('star/team/static/img/tabbg.28cb0f3a.png')}}) center no-repeat;
            background-size: 100% 100%;
            color: #fff;
        }
        ...
        .itemBox2[data-v-5954443c] {
            ...
            background: url({{asset ('star/team/static/img/partnerbg.9e4c14b7.png')}}) center no-repeat;
            background-size: 100% 100%;
            margin-bottom: 0.4rem;
            color: #ffffff;
        }
    ...
    <style type="text/css">
        .page[data-v-37526a6c] {
            min-height: 100vh;
            background: #000 url({{asset ('star/team/static/img/bg-default.7654c155.png')}}) no-repeat;
            background-size: 100% auto;
        }
    ...
    <style type="text/css">
        ...
        .level-box[data-v-55daada6] {
            background: url({{asset ('star/team/static/img/bg-level.48bb2282.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            display: flex;
        }
    ...
    <style type="text/css">
        ...
        .total-income[data-v-f8277c96] {
            margin-top: .2rem;
            overflow: hidden;
            background: url({{asset ('star/team/static/img/bg-chart.aa2ec508.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .wallet-assets .assets-list[data-v-8bfe4f4e] {
            ...
            flex-wrap: wrap;
            padding: .32rem 0;
            background: url({{asset ('star/team/static/img/bg-wallet-assets.e9aa4a59.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .income_box[data-v-14275b54] {
            padding: .28rem;
            background: url({{asset ('star/team/static/img/home-wallet-bg.8a119ff6.png')}}) no-repeat top center;
            background-size: 100% 100%;
            border-radius: .16rem;
        }
    ...
    <style type="text/css">
        .grid-banner[data-v-5f02d15c] {
            ...
            align-items: center;
            line-height: 1.2;
            background: url({{asset ('star/team/static/img/bg-banner.66e8bfef.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .grid-info .level-con[data-v-a156a844] {
            ...
            justify-content: center;
            flex-direction: column;
            background: url({{asset ('star/team/static/img/bg-grid-info-left.9ab0bdb4.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: .24rem .32rem;
        }
        ...
        .grid-info .info-right[data-v-a156a844] {
            ...
            padding: .28rem;
            text-align: center;
            background: url({{asset ('star/team/static/img/bg-grid-info-right.a37bece4.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        [data-v-e157743a] .headers {
            background: url({{asset ('star/team/static/img/bg-home.a6c7beab.png')}}) no-repeat top center !important;
    ...
    <style type="text/css">
        ...
        .grid-trad .trad-left[data-v-ea03dd80] {
            ...
            justify-content: center;
            flex-direction: column;
            background: url({{asset ('star/team/static/img/bg-trad-left.975f1e9d.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: .24rem .32rem;
        }
        ...
        .grid-trad .trad-right .grid-btn[data-v-ea03dd80] {
            ...
            font-size: .24rem;
            padding: 0.07921rem;
            background: url({{asset ('star/team/static/img/bg-grid-btn.dc03b59b.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    </style>
    <style type="text/css">
        .grid-level[data-v-481208f5] {
            ...
            background: url({{asset ('star/team/static/img/bg-grid-card.f68af2cd.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .popup-box .content .grid-level-list .grid-level-item.active[data-v-d0256664] {
            border: none;
            background: url({{asset ('star/team/static/img/bg-grid-level-active.3f9197b3.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .assets-list[data-v-0549ce35] {
            ...
            flex-wrap: wrap;
            padding: 0.4rem;
            background: url({{asset ('star/team/static/img/bg-assets.786bee5d.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .quantify-level[data-v-15212f42] {
            ...
            background: url({{asset ('star/team/static/img/bg-quantify-level.3c28e742.png')}}) no-repeat;
            background-size: 100% 100%;
            display: flex;
            align-items: center;
            justify-content: space-between;
    ...
    <style type="text/css">
        ...
        .grid-content .quantifyRateMax .all[data-v-4681035b] {
            margin-left: 0.1rem;
            padding-left: 0.1rem;
            border-left: 0.02rem solid #01cdd3;
            color: #01cdd3;
            font-size: 0.28rem;
            font-weight: 500;
            line-height: 0.28rem;
        ...
        .trading-btn[data-v-4681035b] {
            ...
            align-items: center;
            justify-content: center;
            background: url({{asset ('star/team/static/img/bg-btn.43aa1b59.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            font-size: 0.32rem;
            text-align: center;
    ...
    background-size: 100% 100%;
        ...
        .tab .select-date[data-v-2d25678c] {
            padding: 0 .24rem;
            border-radius: 1.8rem;
            border: .02rem solid #1a1a1a7766;
            background: linear-gradient(90deg, #01ccd6 0%, #01d6b7 100%);
            box-shadow: 0 0 0.31683rem 0 #1a1a1a7777 inset;
            color: #fff;
            font-size: .24rem;
        }
    ...
    <style type="text/css">
        ...
        .line2 .it .head .info-head .sun span[data-v-46219e99] {
            ...
            background: linear-gradient(93deg, #01cdd3 0.2%, #f7841a 99.77%);
...
<body __processed_45a1e1de-c144-4026-9a7f-7c194fe791c6__="true"
    ...
    <div id="app" class="applang" bis_skin_checked="1">
        <div data-v-37526a6c="" data-v-2d25678c="" class="page" bis_skin_checked="1">
            <div data-v-2d25678c="" data-v-37526a6c="" class="bg" bis_skin_checked="1"></div>
            <div data-v-37526a6c="" class="headers" bis_skin_checked="1">
                <div data-v-0ff1fb10="" data-v-2d25678c="" class="head on" data-v-37526a6c="" bis_skin_checked="1">
                    <div data-v-0ff1fb10="" class="container flex" bis_skin_checked="1">
                        <!---->
                        <div data-v-0ff1fb10="" class="homeIcon" bis_skin_checked="1">
                            <!---->Community team
                        </div>
                        <!---->
                        <div data-v-0ff1fb10="" class="flex1" bis_skin_checked="1"></div>
                        <!---->
                        <div data-v-0ff1fb10="" class="notice" bis_skin_checked="1">
                            <img data-v-0ff1fb10="" src="/star/dash/upload/v1/20260124_170318.png" alt=""><span data-v-0ff1fb10=""> 2 </span>
                        </div>
                        <!---->
            ...
            <div data-v-37526a6c="" id="scroll" class="content-container" bis_skin_checked="1"
                style="padding-top: 52px; padding-bottom: 62px;">
                <div data-v-37526a6c="" id="content" class="content-scroll" bis_skin_checked="1">
                    <div data-v-2d25678c="" data-v-37526a6c="" class="container" bis_skin_checked="1">
                        <div data-v-2d25678c="" data-v-37526a6c="" class="itemBox" bis_skin_checked="1">
                            <div data-v-2d25678c="" data-v-37526a6c="" class="info" bis_skin_checked="1">
                                <div data-v-2d25678c="" data-v-37526a6c="" class="tab wrap bet" bis_skin_checked="1">
                                    <div data-v-2d25678c="" data-v-37526a6c="" class="select-date" bis_skin_checked="1">
                                        <span data-v-2d25678c="" data-v-37526a6c="">Full revenue</span>
                                    </div>
                                    <div data-v-2d25678c="" data-v-37526a6c="" class="check-team" bis_skin_checked="1" onclick="window.location.href='{{route('team.details', 1)}}'">
                                        View team list
                                        <i data-v-2d25678c="" data-v-37526a6c="" class="arrow van-icon van-icon-arrow"><!----></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div data-v-38c37e3e="" data-v-2d25678c="" class="team-assets" data-v-37526a6c=""
                            bis_skin_checked="1">
                            <div data-v-38c37e3e="" class="assets-list" bis_skin_checked="1">
                                <div data-v-38c37e3e="" class="assets-item" bis_skin_checked="1"><img data-v-38c37e3e="" src="{{asset ('star/team/static/img/20260127_160739.png')}}" alt="">
                                    <div data-v-38c37e3e="" class="info" bis_skin_checked="1">
                                        <div data-v-38c37e3e="" class="name" bis_skin_checked="1">Total users</div>
                                        <div data-v-38c37e3e="" class="value" bis_skin_checked="1">{{$team_size}}</div>
                                    </div>
                                </div>
                                <div data-v-38c37e3e="" class="assets-item" bis_skin_checked="1"><img data-v-38c37e3e="" src="{{asset ('star/team/static/img/20260127_160925.png')}}" alt="">
                                    <div data-v-38c37e3e="" class="info" bis_skin_checked="1">
                                        <div data-v-38c37e3e="" class="name" bis_skin_checked="1"> Total Earnings
                                        </div>
                                        <div data-v-38c37e3e="" class="value" bis_skin_checked="1">{{currency()}}{{($levelTotalCommission1 + $levelTotalCommission2 + $levelTotalCommission3)}}</div>
                                    </div>
                                </div>
                                <div data-v-38c37e3e="" class="assets-item" bis_skin_checked="1"><img data-v-38c37e3e="" src="{{asset ('star/team/static/img/20260127_160841.png')}}" alt="">
                                    <div data-v-38c37e3e="" class="info" bis_skin_checked="1">
                                        <div data-v-38c37e3e="" class="name" bis_skin_checked="1">Total Invest
                                        </div>
                                        <div data-v-38c37e3e="" class="value" bis_skin_checked="1">{{price($totalInvestment)}}</div>
                                    </div>
                                </div>
                                <div data-v-38c37e3e="" class="assets-item" bis_skin_checked="1"><img data-v-38c37e3e="" src="{{asset ('star/team/static/img/20260127_160841.png')}}" alt="">
                                    <div data-v-38c37e3e="" class="info" bis_skin_checked="1">
                                        <div data-v-38c37e3e="" class="name" bis_skin_checked="1">Total withdrawal
                                        </div>
                                        <div data-v-38c37e3e="" class="value" bis_skin_checked="1">{{price($lv1Withdraw)}}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div data-v-2d25678c="" data-v-37526a6c="" class="income-box" bis_skin_checked="1">
                            <div data-v-2d25678c="" data-v-37526a6c="" class="income-item bg-item" bis_skin_checked="1">
                                <img data-v-2d25678c="" data-v-37526a6c="" src="{{asset ('star/team/static/img/20260127_161000.png')}}" alt="">
                                <div data-v-2d25678c="" data-v-37526a6c="" class="info" bis_skin_checked="1">
                                    <div data-v-2d25678c="" data-v-37526a6c="" class="name" bis_skin_checked="1">Added
                                        people</div>
                                    <div data-v-2d25678c="" data-v-37526a6c="" class="value" bis_skin_checked="1">{{$team_size}}
                                    </div>
                                </div>
                            </div>
                            <div data-v-2d25678c="" data-v-37526a6c="" class="income-item bg-item" bis_skin_checked="1">
                                <img data-v-2d25678c="" data-v-37526a6c="" src="{{asset ('star/team/static/img/20260127_160925.png')}}" alt="">
                                <div data-v-2d25678c="" data-v-37526a6c="" class="info" bis_skin_checked="1">
                                    <div data-v-2d25678c="" data-v-37526a6c="" class="name" bis_skin_checked="1">Added
                                        income</div>
                                    <div data-v-2d25678c="" data-v-37526a6c="" class="value" bis_skin_checked="1">
                                        <span data-v-2d25678c="" data-v-37526a6c="">{{currency()}}{{($levelTotalCommission1 + $levelTotalCommission2 + $levelTotalCommission3)}}</span></div>
                                </div>
                            </div>
                        </div><img data-v-2d25678c="" data-v-37526a6c="" src="" alt="">
                        <div data-v-2d25678c="" data-v-37526a6c="" class="itemBox" bis_skin_checked="1">
                            <div data-v-2d25678c="" data-v-37526a6c="" class="tame" bis_skin_checked="1">
                                <div data-v-2d25678c="" data-v-37526a6c="" class="tab wrap bet" bis_skin_checked="1">
                                    <div data-v-2d25678c="" data-v-37526a6c="" class="name" bis_skin_checked="1">Three
                                        generations data</div>
                                </div>
                                <div data-v-2d25678c="" data-v-37526a6c="" class="generations-list"
                                    bis_skin_checked="1">
                                    <div data-v-2d25678c="" data-v-37526a6c="" class="it adorn bg-item"
                                        bis_skin_checked="1">
                                        <div data-v-2d25678c="" data-v-37526a6c="" class="name" bis_skin_checked="1">
                                            Level 1 </div>
                                        <!---->
                                        <!---->
                                        <ul data-v-2d25678c="" data-v-37526a6c="" class="db">
                                            <li data-v-2d25678c="" data-v-37526a6c="">
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="s theme"
                                                    bis_skin_checked="1">{{$first_level_users->count()}}/{{$first_level_users->count()}}</div>
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="n"
                                                    bis_skin_checked="1">Number of users</div>
                                            </li>
                                            <li data-v-2d25678c="" data-v-37526a6c="">
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="s"
                                                    bis_skin_checked="1">{{price($lv1Recharge)}}</div>
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="n"
                                                    bis_skin_checked="1">Total recharge</div>
                                            </li>
                                            <li data-v-2d25678c="" data-v-37526a6c="">
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="s"
                                                    bis_skin_checked="1">{{price($lv1Withdraw)}}</div>
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="n"
                                                    bis_skin_checked="1">Total withdrawal</div>
                                            </li>
                                            <li data-v-2d25678c="" data-v-37526a6c="">
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="s"
                                                    bis_skin_checked="1">{{price($levelTotalCommission1)}}</div>
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="n"
                                                    bis_skin_checked="1">Total earnings</div>
                                            </li>
                                        </ul>
                                    </div>
                                    <div data-v-2d25678c="" data-v-37526a6c="" class="it adorn bg-item"
                                        ...
                                        <ul data-v-2d25678c="" data-v-37526a6c="" class="db">
                                            <li data-v-2d25678c="" data-v-37526a6c="">
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="s theme"
                                                    bis_skin_checked="1">{{$second_level_users->count()}}/{{$second_level_users->count()}}</div>
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="n"
                                                    bis_skin_checked="1">Number of users</div>
                                            </li>
                                            <li data-v-2d25678c="" data-v-37526a6c="">
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="s"
                                                    bis_skin_checked="1">{{price($lv2Recharge)}}</div>
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="n"
                                                    bis_skin_checked="1">Total recharge</div>
                                            </li>
                                            <li data-v-2d25678c="" data-v-37526a6c="">
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="s"
                                                    bis_skin_checked="1">{{price($lv2Withdraw)}}</div>
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="n"
                                                    bis_skin_checked="1">Total withdrawal</div>
                                            </li>
                                            <li data-v-2d25678c="" data-v-37526a6c="">
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="s"
                                                    bis_skin_checked="1">{{price($levelTotalCommission2)}}</div>
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="n"
                                                    bis_skin_checked="1">Total earnings</div>
                                            </li>
                                        </ul>
                                    ...
                                    <div data-v-2d25678c="" data-v-37526a6c="" class="it adorn bg-item"
                                        ...
                                        <ul data-v-2d25678c="" data-v-37526a6c="" class="db">
                                            <li data-v-2d25678c="" data-v-37526a6c="">
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="s theme"
                                                    bis_skin_checked="1">{{$third_level_users->count()}}/{{$third_level_users->count()}}</div>
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="n"
                                                    bis_skin_checked="1">Number of users</div>
                                            </li>
                                            <li data-v-2d25678c="" data-v-37526a6c="">
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="s"
                                                    bis_skin_checked="1">{{price($lv3Recharge)}}</div>
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="n"
                                                    bis_skin_checked="1">Total recharge</div>
                                            </li>
                                            <li data-v-2d25678c="" data-v-37526a6c="">
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="s"
                                                    bis_skin_checked="1">{{price($lv3Withdraw)}}</div>
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="n"
                                                    bis_skin_checked="1">Total withdrawal</div>
                                            </li>
                                            <li data-v-2d25678c="" data-v-37526a6c="">
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="s"
                                                    bis_skin_checked="1">{{price($levelTotalCommission3)}}</div>
                                                <div data-v-2d25678c="" data-v-37526a6c="" class="n"
                                                    bis_skin_checked="1">Total earnings</div>
                                            </li>
                                        </ul>
            ...
            <div data-v-37526a6c="" class="footer" bis_skin_checked="1">
                <div data-v-6c4d8baa="" data-v-e157743a="" class="footers" data-v-37526a6c="" bis_skin_checked="1" >
                    ...
                    <div data-v-6c4d8baa="" class="item" bis_skin_checked="1" onclick="window.location.href='{{route ('vip')}}'">
                        <div data-v-6c4d8baa="" class="on" bis_skin_checked="1"><img data-v-6c4d8baa="" src="{{asset ('star/dash/upload/v1/20250724_033641.png')}}" alt="">
                            <!---->
                        </div>
                    </div>
                    <div data-v-6c4d8baa="" class="item" bis_skin_checked="1"onclick="window.location.href='{{route ('user.team')}}'" >
                        <div data-v-6c4d8baa="" class="on" bis_skin_checked="1">
                            <img data-v-6c4d8baa="" src="{{asset ('star/dash/upload/v1/20260124_163048.png')}}" alt=""><span data-v-6c4d8baa="">Team</span>
                        </div>
                    </div>
                    <div data-v-6c4d8baa="" class="item" bis_skin_checked="1"onclick="window.location.href='{{route ('profile')}}'" >
                        <div data-v-6c4d8baa="" class="" bis_skin_checked="1">
                            <img data-v-6c4d8baa="" src="{{asset ('star/dash/upload/v1/20250724_023242.png')}}" alt=""><span data-v-6c4d8baa="">Mine</span>
                        </div>
                    </div>
                </div>
            </div>
