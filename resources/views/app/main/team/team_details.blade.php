  ...
  */
    ...
    <style type="text/css">
        ...
        .popup_box .popup-content-head[data-v-75ed67aa] {
            ...
            width: 100%;
            height: 2.6rem;
            background-image: url({{asset ('star/teaml/static/img/home_popup_top_bg.8bed63d3.png')}});
            background-size: 100% 100%;
            background-repeat: no-repeat;
    ...
    <style type="text/css">
        .card-con[data-v-0cd9ae3e] {
            ...
            margin: .4rem 0 .54rem;
            display: flex;
            background: url({{asset ('star/teaml/static/img/invitebg.cdfe3b13.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .home-video[data-v-bda0bfee] {
            ...
            background: url({{asset ('star/teaml/static/img/bg-video.9e4c14b7.png')}}) no-repeat;
            background-size: 100% 100%;
            position: relative;
        }
    ...
    <style type="text/css">
        .market-item[data-v-4d062292] {
            width: calc(48%);
            padding: .32rem .28rem;
            background: url({{asset ('star/teaml/static/img/bg-market-item.ade5668a.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .bg[data-v-5954443c] {
            background: #000 url({{asset ('star/teaml/static/img/bg-home.a6c7beab.png')}}) no-repeat;
        ...
        .home-introduce .introduce-info[data-v-5954443c] {
            flex: 1;
            padding: .36rem .32rem;
            background: url({{asset ('star/teaml/static/img/jieshaobg.663a51d7.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
        ...
        .home-notice[data-v-5954443c] {
            position: relative;
            margin-top: 0.19802rem;
            background: url({{asset ('star/teaml/static/img/linebg.eec555f4.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
        ...
        .name-1 .tab .active[data-v-5954443c] {
            background: url({{asset ('star/teaml/static/img/tabbg.28cb0f3a.png')}}) center no-repeat;
            background-size: 100% 100%;
            color: #fff;
        }
        ...
        .itemBox2[data-v-5954443c] {
            ...
            background: url({{asset ('star/teaml/static/img/partnerbg.9e4c14b7.png')}}) center no-repeat;
            background-size: 100% 100%;
            margin-bottom: 0.4rem;
            color: #ffffff;
        }
    ...
    <style type="text/css">
        ...
        .level-box[data-v-55daada6] {
            background: url({{asset ('star/teaml/static/img/bg-level.48bb2282.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            display: flex;
        }
    ...
    <style type="text/css">
        ...
        .total-income[data-v-f8277c96] {
            margin-top: .2rem;
            overflow: hidden;
            background: url({{asset ('star/teaml/static/img/bg-chart.aa2ec508.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .wallet-assets .assets-list[data-v-8bfe4f4e] {
            ...
            flex-wrap: wrap;
            padding: .32rem 0;
            background: url({{asset ('star/teaml/static/img/bg-wallet-assets.e9aa4a59.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .income_box[data-v-14275b54] {
            padding: .28rem;
            background: url({{asset ('star/teaml/static/img/home-wallet-bg.8a119ff6.png')}}) no-repeat top center;
            background-size: 100% 100%;
            border-radius: .16rem;
        }
    ...
    <style type="text/css">
        .grid-banner[data-v-5f02d15c] {
            ...
            align-items: center;
            line-height: 1.2;
            background: url({{asset ('star/teaml/static/img/bg-banner.66e8bfef.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .grid-info .level-con[data-v-a156a844] {
            ...
            justify-content: center;
            flex-direction: column;
            background: url({{asset ('star/teaml/static/img/bg-grid-info-left.9ab0bdb4.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: .24rem .32rem;
        }
        ...
        .grid-info .info-right[data-v-a156a844] {
            ...
            padding: .28rem;
            text-align: center;
            background: url({{asset ('star/teaml/static/img/bg-grid-info-right.a37bece4.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        [data-v-e157743a] .headers {
            background: url({{asset ('star/teaml/static/img/bg-home.a6c7beab.png')}}) no-repeat top center !important;
    ...
    <style type="text/css">
        ...
        .grid-trad .trad-left[data-v-ea03dd80] {
            ...
            justify-content: center;
            flex-direction: column;
            background: url({{asset ('star/teaml/static/img/bg-trad-left.975f1e9d.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: .24rem .32rem;
        }
        ...
        .grid-trad .trad-right .grid-btn[data-v-ea03dd80] {
            ...
            font-size: .24rem;
            padding: 0.07921rem;
            background: url({{asset ('star/teaml/static/img/bg-grid-btn.dc03b59b.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    </style>
    <style type="text/css">
        .grid-level[data-v-481208f5] {
            ...
            background: url({{asset ('star/teaml/static/img/bg-grid-card.f68af2cd.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .popup-box .content .grid-level-list .grid-level-item.active[data-v-d0256664] {
            border: none;
            background: url({{asset ('star/teaml/static/img/bg-grid-level-active.3f9197b3.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .assets-list[data-v-0549ce35] {
            ...
            flex-wrap: wrap;
            padding: 0.4rem;
            background: url({{asset ('star/teaml/static/img/bg-assets.786bee5d.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .quantify-level[data-v-15212f42] {
            ...
            background: url({{asset ('star/teaml/static/img/bg-quantify-level.3c28e742.png')}}) no-repeat;
            background-size: 100% 100%;
            display: flex;
            align-items: center;
            justify-content: space-between;
    ...
    <style type="text/css">
        ...
        .trading-btn[data-v-4681035b] {
            ...
            align-items: center;
            justify-content: center;
            background: url({{asset ('star/teaml/static/img/bg-btn.43aa1b59.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            font-size: 0.32rem;
            text-align: center;
    ...
    <style type="text/css">
        .assets-list[data-v-38c37e3e] {
            padding: .4rem .28rem;
            background: url({{asset ('star/teaml/static/img/bg-asstes-card.ce8df5cb.png')}}) no-repeat;
            background-size: 100% 100%;
            display: flex;
            align-items: center;
            flex-wrap: wrap;
    ...
    <style type="text/css">
        ...
        [data-v-502a7a73] .van-tab--active {
            border-radius: 1.8rem;
            border: .02rem solid linear-gradient(90deg, #01ccd6 0%, #01d6b7 100%);
            background: linear-gradient(90deg, #01ccd6 0%, #01d6b7 100%);
            box-shadow: 0 0 0.31683rem 0 linear-gradient(90deg, #f79102 0%, #ef6115 100%) inset;
            color: #fff;
        }
    </style>
    <style type="text/css">
    ...
    <style type="text/css">
        ...
        .line2 .it .head .info-head .sun span[data-v-46219e99] {
            display: inline-block;
            box-shadow: 0 0.08rem 0.16rem 0 linear-gradient(90deg, #01ccd6 0%, #01d6b7 100%);
            background: linear-gradient(90deg, #01ccd6 0%, #01d6b7 100%);
    ...
    <style type="text/css">
        ...
        .my-head .avatar[data-v-5eb5f75c] {
            width: 1.32rem;
            height: 1.32rem;
            background: url({{asset ('star/teaml/static/img/bg-avatar.82eba0fb.png')}}) no-repeat;
            background-size: 100% 100%;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .my-head .avatar[data-v-5eb5f75c]:before {
            ...
            width: 3.6rem;
            height: .6rem;
            background: url({{asset ('star/teaml/static/img/bg-WavyLines.b341f9e1.png')}}) no-repeat;
            background-size: 100% 100%;
            position: absolute;
            top: .4rem;
            left: 50%;
    ...
    <style type="text/css">
        ...
        .my-navs .nav[data-v-1f0d3d2c] {
            ...
            display: flex;
            flex-direction: column;
            background: url({{asset ('star/teaml/static/img/bg-navs.09e271a2.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: .4rem .32rem;
        }
    ...
    <style type="text/css">
        .heads[data-v-7a3d5949] {
            padding: 0.28rem 0;
            background: url({{asset ('star/teaml/static/img/bg_my.9fbfe6c2.png')}}) no-repeat 0 -1rem;
            background-size: 100% auto;
        }
        ...
        .g1[data-v-7a3d5949] {
            background: url({{asset ('star/teaml/static/img/bg_banner.b3f69096.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            margin-top: 0.32rem;
        }
        ...
        .g1 .flex .level-btn[data-v-7a3d5949] {
            font-size: 0.24rem;
            background: url({{asset ('star/teaml/static/img/bg-min-btn.5cfb3e60.png')}}) no-repeat;
            background-size: 100% 100%;
            border-radius: 1.8rem;
        ...
        .line .module[data-v-7a3d5949] {
            ...
            background: url({{asset ('star/teaml/static/img/bg-list.ebe69d90.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .bg[data-v-2a224bbc] {
            background: #000 url({{asset ('star/teaml/static/img/bg_invite.10776553.png')}}) no-repeat;
            background-size: 100% auto;
            width: 100%;
            height: 100%;
        }
        ...
        .invite-con[data-v-2a224bbc] {
            ...
            background: url({{asset ('star/teaml/static/img/bg-invite-con.0a4a121d.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: 0 .32rem;
        }
        ...
        .invite-con .qrcode-box .qrcode-con[data-v-2a224bbc] {
            width: fit-content;
            padding: .32rem;
            background: url({{asset ('star/teaml/static/img/bg-qrcode.79d104a8.png')}}) no-repeat;
            background-size: 100% 100%;
        }
...
<body __processed_45a1e1de-c144-4026-9a7f-7c194fe791c6__="true"
    ...
    <div id="app" class="applang" bis_skin_checked="1">
        <div data-v-37526a6c="" data-v-46219e99="" class="page" bis_skin_checked="1">
            <div data-v-37526a6c="" class="headers" bis_skin_checked="1">
                <div data-v-46219e99="" data-v-37526a6c="" bis_skin_checked="1">
                    <div data-v-0ff1fb10="" data-v-46219e99="" class="head on" data-v-37526a6c="" bis_skin_checked="1">
                        <div data-v-0ff1fb10="" class="container flex" bis_skin_checked="1" onclick="window.location.href='{{route('user.team')}}'">
                            <div data-v-0ff1fb10="" class="back" bis_skin_checked="1"><img data-v-0ff1fb10="" src="{{asset ('star/rc/static/img/ico_back.ceeff0ae.png')}}" alt="">
                            </div>
                            <!---->
                            <div data-v-0ff1fb10="" class="name tac" bis_skin_checked="1"> Team List </div>
                    ...
                    <div data-v-502a7a73="" data-v-46219e99="" class="tab_box" data-v-37526a6c="" bis_skin_checked="1">
                        <div data-v-502a7a73="" class="van-tabs van-tabs--line" bis_skin_checked="1">
                            <div class="van-tabs__wrap" bis_skin_checked="1">
                                <div role="tablist" class="van-tabs__nav van-tabs__nav--line" bis_skin_checked="1">
                               
  @if($generation == 1)
                      <div role="tab" class="van-tab van-tab--active" bis_skin_checked="1"
                                        aria-selected="true">
                                        <span class="van-tab__text van-tab__text--ellipsis"><div data-v-502a7a73="" bis_skin_checked="1"><div data-v-502a7a73="" class="tabs_title tabs_title_active" bis_skin_checked="1"> Level 1 </div></div></span>
                                    </div>
                                          <div role="tab" class="van-tab" bis_skin_checked="1" onclick="window.location.href='{{route('team.details', 2)}}'" >
                                        <span class="van-tab__text van-tab__text--ellipsis"><div data-v-502a7a73="" bis_skin_checked="1"><div data-v-502a7a73="" class="tabs_title" bis_skin_checked="1"> Level 2 </div></div></span>
                                    </div>
                                         <div role="tab" class="van-tab" bis_skin_checked="1"onclick="window.location.href='{{route('team.details', 3)}}'"  >
                                        <span class="van-tab__text van-tab__text--ellipsis"><div data-v-502a7a73="" bis_skin_checked="1"><div data-v-502a7a73="" class="tabs_title" bis_skin_checked="1"> Level 3 </div></div></span>
                                    </div>
                @elseif($generation == 2)
                                    <div role="tab" class="van-tab " bis_skin_checked="1" onclick="window.location.href='{{route('team.details', 1)}}'"
                                        aria-selected="true">
                                        <span class="van-tab__text van-tab__text--ellipsis"><div data-v-502a7a73="" bis_skin_checked="1"><div data-v-502a7a73="" class="tabs_title " bis_skin_checked="1"> Level 1</div></div></span>
                                    </div>
                                          <div role="tab" class="van-tab van-tab--active " bis_skin_checked="1"  >
                                        <span class="van-tab__text van-tab__text--ellipsis"><div data-v-502a7a73="" bis_skin_checked="1"><div data-v-502a7a73="" class="tabs_title tabs_title_active" bis_skin_checked="1"> Level 2</div></div></span>
                                    </div>
                                         <div role="tab" class="van-tab" bis_skin_checked="1"onclick="window.location.href='{{route('team.details', 3)}}'"  >
                                        <span class="van-tab__text van-tab__text--ellipsis"><div data-v-502a7a73="" bis_skin_checked="1"><div data-v-502a7a73="" class="tabs_title" bis_skin_checked="1"> Level 3 </div></div></span>
                                    </div>
                @elseif($generation == 3)
                           <div role="tab" class="van-tab " bis_skin_checked="1" onclick="window.location.href='{{route('team.details', 1)}}'"
                                        ...
                                        <span class="van-tab__text van-tab__text--ellipsis"><div data-v-502a7a73="" bis_skin_checked="1"><div data-v-502a7a73="" class="tabs_title" bis_skin_checked="1"> Level 2</div></div></span>
                                         ...
                                         <div role="tab" class="van-tab van-tab--active" bis_skin_checked="1"  >
                                        <span class="van-tab__text van-tab__text--ellipsis"><div data-v-502a7a73="" bis_skin_checked="1"><div data-v-502a7a73="" class="tabs_title tabs_title_active" bis_skin_checked="1"> Level 3 </div></div></span>
                                    </div>
                @else
                ...
                @endif
                                    ...
                                    <div class="van-tabs__line"
                                        style="width: 0.4rem; transform: (65.5px) (-50%); transition-duration: 0.3s;"
            ...
            <div data-v-37526a6c="" id="scroll" class="content-container" style="padding-top: 89px;"
                bis_skin_checked="1">
                <div data-v-37526a6c="" id="content" class="content-scroll" bis_skin_checked="1">
                    <div data-v-46219e99="" data-v-37526a6c="" class="container" bis_skin_checked="1">
                        <div data-v-46219e99="" data-v-37526a6c="" class="empty db" style="display: none;"
                            bis_skin_checked="1">
                            <div data-v-46219e99="" data-v-37526a6c="" class="flexs" bis_skin_checked="1">
                                <div data-v-46219e99="" class="custom-image van-empty" data-v-37526a6c=""
                                    bis_skin_checked="1">
                                    <div class="van-empty__image" bis_skin_checked="1"><img src="{{asset ('star/teaml/static/img/none.c55b1bf6.png')}}">
                                    </div>
                                    <p class="van-empty__description">No record yet</p>
                                </div>
                            </div>
                        </div>
                        <div data-v-46219e99="" class="van-pull-refresh" data-v-37526a6c="" bis_skin_checked="1">
                            <div class="van-pull-refresh__track" bis_skin_checked="1" style="transition-duration: 0ms;">
                                <div class="van-pull-refresh__head" bis_skin_checked="1" style="height: 50px;"></div>


                                <div data-v-46219e99="" role="feed" class="van-list" bis_skin_checked="1">
                                  @foreach($users as $element)
                                    <div data-v-46219e99="" class="itemBox" bis_skin_checked="1">
                                        <div data-v-46219e99="" class="line2 bg-item" bis_skin_checked="1">
                                            <div data-v-46219e99="" class="it" bis_skin_checked="1">
                                                <div data-v-46219e99="" class="head flex" bis_skin_checked="1">
                                                    <div data-v-46219e99="" class="photo" bis_skin_checked="1"><img data-v-46219e99="" src="/v1/20260126_082332.jpg" alt="">
                                                    </div>
                                                    <div data-v-46219e99="" class="info flex1" bis_skin_checked="1">
                                                        <div data-v-46219e99="" class="info-head" bis_skin_checked="1">
                                                            <div data-v-46219e99="" class="head-left"
                                                                bis_skin_checked="1">
                                                                <div data-v-46219e99="" class="n" bis_skin_checked="1">
                                                                    <span data-v-46219e99="">(ID：{{$element->ref_id}})</span><span data-v-46219e99="" class="remark overflow1"> Remark </span>
                                                                    <!---->
                                                                </div>
                                                                <div data-v-46219e99="" class="level-info flex"
                                                                    bis_skin_checked="1">
                                                                    <!---->
                                                                    <!---->
                                                                </div>
                                                            </div>
                                                            <div data-v-46219e99="" class="head-right"
                                                                bis_skin_checked="1">
                                                                <div data-v-46219e99="" class="sun"
                                                                    bis_skin_checked="1">
                                                                    <span data-v-46219e99="" class="">  Active </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div data-v-46219e99="" class="info-bot" bis_skin_checked="1">
                                                            <div data-v-46219e99="" class="time" bis_skin_checked="1">
                                                                 {{$element->created_at}}</div>
                                                            <div data-v-46219e99="" class="status" bis_skin_checked="1">
                                                                </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <ul data-v-46219e99="">
                                                ...
                                                <li data-v-46219e99="">
                                                    <div data-v-46219e99="" class="s" bis_skin_checked="1">{{(\App\Models\Deposit::where('status', 'approved')->where('user_id', $element->id)->sum('amount'))}} USDT</div>
                                                    <div data-v-46219e99="" class="n" bis_skin_checked="1">Total
                                                        recharge</div>
                                                </li>
                                                <li data-v-46219e99="">
                                                    <div data-v-46219e99="" class="s" bis_skin_checked="1">{{(\App\Models\Withdrawal::where('status', 'approved')->where('user_id', $element->id)->sum('amount'))}} USDT</div>
                                                    <div data-v-46219e99="" class="n" bis_skin_checked="1">Total
                                                        withdrawal</div>
                                                </li>
                                            </ul>
       ...
       @endforeach
                                    ...
                                    <div class="van-list__finished-text" bis_skin_checked="1">No more</div>
                                    <div class="van-list__placeholder" bis_skin_checked="1"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!---->
    <div class="van-toast van-toast--middle van-toast--text" bis_skin_checked="1" style="z-index: 2003; display: none;">
