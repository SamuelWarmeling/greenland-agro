...
*/
    ...
    <style type="text/css">
        ...
        .my-head .avatar[data-v-5eb5f75c] {
            width: 1.32rem;
            height: 1.32rem;
            background: url({{asset ('star/service/static/img/bg-avatar.82eba0fb.png')}}) no-repeat;
            background-size: 100% 100%;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .my-head .avatar[data-v-5eb5f75c]:before {
            ...
            width: 3.6rem;
            height: .6rem;
            background: url({{asset ('star/service/static/img/bg-WavyLines.b341f9e1.png')}}) no-repeat;
            background-size: 100% 100%;
            position: absolute;
            top: .4rem;
            left: 50%;
    ...
    <style type="text/css">
        ...
        .my-navs .nav[data-v-1f0d3d2c] {
            ...
            display: flex;
            flex-direction: column;
            background: url({{asset ('star/service/static/img/bg-navs.09e271a2.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: .4rem .32rem;
        }
    ...
    <style type="text/css">
        .heads[data-v-7a3d5949] {
            padding: 0.28rem 0;
            background: url({{asset ('star/service/static/img/bg_my.9fbfe6c2.png')}}) no-repeat 0 -1rem;
        ...
        .g1[data-v-7a3d5949] {
            background: url({{asset ('star/service/static/img/bg_banner.b3f69096.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            margin-top: 0.32rem;
        }
        ...
        .g1 .flex .level-btn[data-v-7a3d5949] {
            font-size: 0.24rem;
            background: url({{asset ('star/service/static/img/bg-min-btn.5cfb3e60.png')}}) no-repeat;
            background-size: 100% 100%;
            border-radius: 1.8rem;
        ...
        .line .module[data-v-7a3d5949] {
            ...
            background: url({{asset ('star/service/static/img/bg-list.ebe69d90.png')}}) no-repeat;
            background-size: 100% 100%;
        }
        ...
        .btn-list .btn-quit[data-v-7a3d5949] {
            background: url({{asset ('star/service/static/img/tabbg.28cb0f3a.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
  ...
  */
    ...
    <style type="text/css">
        ...
        .popup_box .popup-content-head[data-v-75ed67aa] {
            ...
            width: 100%;
            height: 2.6rem;
            background-image: url({{asset ('star/service/static/img/home_popup_top_bg.8bed63d3.png')}});
            background-size: 100% 100%;
            background-repeat: no-repeat;
    ...
    <style type="text/css">
        .card-con[data-v-0cd9ae3e] {
            ...
            margin: .4rem 0 .54rem;
            display: flex;
            background: url({{asset ('star/service/static/img/invitebg.cdfe3b13.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .home-video[data-v-bda0bfee] {
            ...
            background: url({{asset ('star/service/static/img/bg-video.9e4c14b7.png')}}) no-repeat;
            background-size: 100% 100%;
            position: relative;
        }
    ...
    <style type="text/css">
        .market-item[data-v-4d062292] {
            width: calc(48%);
            padding: .32rem .28rem;
            background: url({{asset ('star/service/static/img/bg-market-item.ade5668a.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .bg[data-v-5954443c] {
            background: #000 url({{asset ('star/service/static/img/bg-home.a6c7beab.png')}}) no-repeat;
            background-size: 100% auto;
            width: 100%;
            height: 100%;
        }
        ...
        .home-introduce .introduce-info[data-v-5954443c] {
            flex: 1;
            padding: .36rem .32rem;
            background: url({{asset ('star/service/static/img/jieshaobg.663a51d7.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
        ...
        .home-notice[data-v-5954443c] {
            position: relative;
            margin-top: 0.19802rem;
            background: url({{asset ('star/service/static/img/linebg.eec555f4.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
        ...
        .itemBox2[data-v-5954443c] {
            ...
            background: url({{asset ('star/service/static/img/partnerbg.9e4c14b7.png')}}) center no-repeat;
            background-size: 100% 100%;
            margin-bottom: 0.4rem;
            color: #ffffff;
        }
    ...
    <style type="text/css">
        ...
        .level-box[data-v-55daada6] {
            background: url({{asset ('star/service/static/img/bg-level.48bb2282.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            display: flex;
        }
...
<body __processed_d177660a-3d5a-4a82-945b-17b4f4297e3c__="true" class="w856"
    ...
    <div id="app" class="applang" bis_skin_checked="1">
        <div data-v-37526a6c="" data-v-6b354bc2="" class="page" bis_skin_checked="1">
            <div data-v-37526a6c="" class="headers" bis_skin_checked="1">
                <div data-v-0ff1fb10="" data-v-6b354bc2="" class="head on" data-v-37526a6c="" bis_skin_checked="1">
                    <div data-v-0ff1fb10="" class="container flex" bis_skin_checked="1">
                        ...
                        <!---->
                        <div data-v-0ff1fb10="" class="name tac" bis_skin_checked="1"> Support media </div>
            ...
            <div data-v-37526a6c="" id="scroll" class="content-container" bis_skin_checked="1"
                ...
                <div data-v-37526a6c="" id="content" class="content-scroll" bis_skin_checked="1">
                    <div data-v-6b354bc2="" data-v-37526a6c="" class="container" bis_skin_checked="1">
                        <div data-v-6b354bc2="" data-v-37526a6c="" class="item" bis_skin_checked="1" onclick="window.location.href='https://www.instagram.com/'">
                            <div data-v-6b354bc2="" data-v-37526a6c="" class="top" bis_skin_checked="1"><img data-v-6b354bc2="" data-v-37526a6c="" src="{{asset ('star/service/upload/20250117/1f243ff7275f2dabae89cf0cbfdf9cb7.png')}}" alt=""> Instagram
                            </div>
                            <div data-v-6b354bc2="" data-v-37526a6c="" class="bot" bis_skin_checked="1">
                                https://www.instagram.com/ <img data-v-6b354bc2="" data-v-37526a6c="" src="{{asset ('star/rc/static/img/20250725_111908.png')}}" alt="">
                            </div>
                        </div>
                        <div data-v-6b354bc2="" data-v-37526a6c="" class="item" bis_skin_checked="1" onclick="window.location.href='https://www.youtube.com/'">
                            <div data-v-6b354bc2="" data-v-37526a6c="" class="top" bis_skin_checked="1"><img data-v-6b354bc2="" data-v-37526a6c="" src="{{asset ('star/service/upload/20250117/821c51210c22f4fa92da4b8a8378580f.png')}}" alt=""> YouTube
                            </div>
                            <div data-v-6b354bc2="" data-v-37526a6c="" class="bot" bis_skin_checked="1">
                                https://www.youtube.com/ <img data-v-6b354bc2="" data-v-37526a6c="" src="{{asset ('star/rc/static/img/20250725_111908.png')}}" alt="">
                            </div>
                        </div>
                        <div data-v-6b354bc2="" data-v-37526a6c="" class="item" bis_skin_checked="1" onclick="window.location.href='https://t.me/webdeveloper_sun'">
                            <div data-v-6b354bc2="" data-v-37526a6c="" class="top" bis_skin_checked="1"><img data-v-6b354bc2="" data-v-37526a6c="" src="{{asset ('star/service/upload/20250117/1a9a080bcf5feff136f6a7c802e47fbc.png')}}" alt=""> telegram
                            </div>
                            <div data-v-6b354bc2="" data-v-37526a6c="" class="bot" bis_skin_checked="1">
                                https://t.me/webdeveloper_sun<img data-v-6b354bc2="" data-v-37526a6c="" src="{{asset ('star/rc/static/img/20250725_111908.png')}}" alt="">
                            </div>
                        </div>
                        <div data-v-6b354bc2="" data-v-37526a6c="" class="item" bis_skin_checked="1" onclick="window.location.href='https://www.facebook.com/'">
                            <div data-v-6b354bc2="" data-v-37526a6c="" class="top" bis_skin_checked="1"><img data-v-6b354bc2="" data-v-37526a6c="" src="{{asset ('star/service/upload/20250117/73a89ac41b82b869a6a22f4f6763df3c.png')}}" alt=""> facebook
                            </div>
                            <div data-v-6b354bc2="" data-v-37526a6c="" class="bot" bis_skin_checked="1">
                                https://www.facebook.com/ <img data-v-6b354bc2="" data-v-37526a6c="" src="{{asset ('star/rc/static/img/20250725_111908.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
