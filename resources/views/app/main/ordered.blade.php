  ...
  */
    ...
    <style type="text/css">
        .card-con[data-v-0cd9ae3e] {
            ...
            margin: .4rem 0 .54rem;
            display: flex;
            background: url({{asset ('star/order/static/img/invitebg.cdfe3b13.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .home-video[data-v-bda0bfee] {
            ...
            background: url({{asset ('star/order/static/img/bg-video.9e4c14b7.png')}}) no-repeat;
            background-size: 100% 100%;
            position: relative;
        }
    ...
    <style type="text/css">
        .market-item[data-v-4d062292] {
            width: calc(48%);
            padding: .32rem .28rem;
            background: url({{asset ('star/order/static/img/bg-market-item.ade5668a.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .home-introduce .introduce-info[data-v-5954443c] {
            flex: 1;
            padding: .36rem .32rem;
            background: url({{asset ('star/order/static/img/jieshaobg.663a51d7.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
        ...
        .home-notice[data-v-5954443c] {
            position: relative;
            margin-top: 0.19802rem;
            background: url({{asset ('star/order/static/img/linebg.eec555f4.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
        ...
        .name-1 .tab .active[data-v-5954443c] {
            background: url({{asset ('star/order/static/img/tabbg.28cb0f3a.png')}}) center no-repeat;
            background-size: 100% 100%;
            color: #fff;
        }
        ...
        .itemBox2[data-v-5954443c] {
            ...
            background: url({{asset ('star/order/static/img/partnerbg.9e4c14b7.png')}}) center no-repeat;
            background-size: 100% 100%;
            margin-bottom: 0.4rem;
            color: #ffffff;
        }
    ...
    <style type="text/css">
        ...
        .level-box[data-v-55daada6] {
            background: url({{asset ('star/order/static/img/bg-level.48bb2282.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            display: flex;
        }
    ...
    <style type="text/css">
        ...
        .total-income[data-v-f8277c96] {
            margin-top: .2rem;
            overflow: hidden;
            background: url({{asset ('star/order/static/img/bg-chart.aa2ec508.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .wallet-assets .assets-list[data-v-8bfe4f4e] {
            ...
            flex-wrap: wrap;
            padding: .32rem 0;
            background: url({{asset ('star/order/static/img/20260129_000352.png')}}) no-repeat;
            background-size: 100% 100%;
        }
        ...
        .wallet-assets .bot .bot-left .btn-item[data-v-8bfe4f4e] {
            ...
            background: #1a1a1a;
            box-shadow: 0 0 0.32rem 0 #1a1a1a inset;
            padding: .16rem .24rem;
            display: flex;
            align-items: center;
            justify-content: center;
    ...
    <style type="text/css">
        ...
        .income_box[data-v-14275b54] {
            padding: .28rem;
            background: url({{asset ('star/order/static/img/home-wallet-bg.8a119ff6.png')}}) no-repeat top center;
            background-size: 100% 100%;
            border-radius: .16rem;
        }
        ...
        .wallet-assets .assets-info .value1[data-v-8bfe4f4e]
Specificity: (0,4,0)
 {
    margin-top: .08rem;
    color: #fff;
...
<body __processed_45a1e1de-c144-4026-9a7f-7c194fe791c6__="true"
    ...
    class="w856 van-overflow-hidden">
    ...
    <div id="app" class="applang" bis_skin_checked="1">
        <div data-v-37526a6c="" data-v-14275b54="" class="page" bis_skin_checked="1">
            <div data-v-14275b54="" data-v-37526a6c="" class="bg" bis_skin_checked="1"></div>
            <div data-v-37526a6c="" class="headers" bis_skin_checked="1">
                <div data-v-0ff1fb10="" data-v-14275b54="" class="head on" data-v-37526a6c="" bis_skin_checked="1">
            ...
            <div data-v-37526a6c="" id="scroll" class="content-container"
                style="padding-top: 52px; padding-bottom: 62px;" bis_skin_checked="1">
                <div data-v-37526a6c="" id="content" class="content-scroll" bis_skin_checked="1">
                    <div data-v-14275b54="" data-v-37526a6c="" class="container" bis_skin_checked="1">
                        <div data-v-8bfe4f4e="" data-v-14275b54="" class="wallet-assets" data-v-37526a6c=""
                            bis_skin_checked="1">
                            <div data-v-8bfe4f4e="" class="total-assets" bis_skin_checked="1"><img data-v-8bfe4f4e="" src="{{asset ('star/order/static/img/20260129_002523.png')}}" alt="">
                                <div data-v-8bfe4f4e="" class="assets-info" bis_skin_checked="1">
                                    <div data-v-8bfe4f4e="" class="name" bis_skin_checked="1"> Overview Assets ({{currency()}})
                                    </div>
                                    <div data-v-8bfe4f4e="" class="value1" bis_skin_checked="1"> {{(auth()->user()->balance)}}</div>
                                </div>
                            </div>
                            <div data-v-8bfe4f4e="" class="assets-list" bis_skin_checked="1">
                                <div data-v-8bfe4f4e="" class="assets-info" bis_skin_checked="1">
                                    <div data-v-8bfe4f4e="" class="name" bis_skin_checked="1"> Receiveable funds ({{currency()}})
                                    </div>
                                    <div data-v-8bfe4f4e="" class="value" bis_skin_checked="1">{{price(auth()->user()->receive_able_amount)}} </div>
                                </div>  <?php
                                $tWithdraw = \App\Models\Withdrawal::where('user_id', auth()->user()->id)->where('status', 'approved')->sum('amount');
                                ?>
                                <div data-v-8bfe4f4e="" class="assets-info" bis_skin_checked="1">
                                    <div data-v-8bfe4f4e="" class="name" bis_skin_checked="1"> To be released ({{currency()}})
                                    </div>
                                    <div data-v-8bfe4f4e="" class="value" bis_skin_checked="1"> {{($tWithdraw)}}</div>
                                </div>
                                 <?php
                                $tCom = \App\Models\UserLedger::where('user_id', auth()->user()->id)->where('reason', 'commission')->sum('amount');
                                ?>
                                <div data-v-8bfe4f4e="" class="assets-info" bis_skin_checked="1">
                                    <div data-v-8bfe4f4e="" class="name" bis_skin_checked="1"> Team benefits ({{currency()}})
                                    </div>
                                    <div data-v-8bfe4f4e="" class="value" bis_skin_checked="1"> {{($tCom)}}</div>
                                </div>
                                <div data-v-8bfe4f4e="" class="assets-info" bis_skin_checked="1">
                                    <div data-v-8bfe4f4e="" class="name" bis_skin_checked="1"> Daily Income ({{currency()}})
                                    </div>
                                    <div data-v-8bfe4f4e="" class="value" bis_skin_checked="1"> {{price(\App\Models\Purchase::where('user_id', auth()->user()->id)->where('status', 'active')->sum('daily_income'))}}</div>
                                </div>
                            </div>
                            <div data-v-8bfe4f4e="" class="bot" bis_skin_checked="1">
                                <div data-v-8bfe4f4e="" class="bot-left" bis_skin_checked="1">
                                    <div data-v-8bfe4f4e="" class="btn-item" bis_skin_checked="1" onclick="window.location.href='{{route('user.received.amount')}}'">
                                        <img data-v-8bfe4f4e="" src="data:image/png;base64," alt=""><span data-v-8bfe4f4e="">Claim Earning</span>
                                    </div>

                                </div>
                                <div data-v-8bfe4f4e="" class="bot-right" bis_skin_checked="1"><img data-v-8bfe4f4e="" src="{{asset ('star/order/static/img/icon-record.3cf02678.png')}}" alt="">
                                </div>
                            </div>
                        </div><i data-v-14275b54="" data-v-37526a6c="" src="" alt="" class="mt32">
                    </div>
                    <div data-v-14275b54="" data-v-37526a6c="" class="container" bis_skin_checked="1">
                        <div data-v-14275b54="" data-v-37526a6c="" class="asset_box" bis_skin_checked="1">
                            <div data-v-14275b54="" data-v-37526a6c="" class="list" bis_skin_checked="1">
                    
                            </div>
                        </div>
                    </div>
                    <div data-v-f8277c96="" data-v-14275b54="" class="revenue" data-v-37526a6c="" bis_skin_checked="1">
                        <div data-v-f8277c96="" class="rel container" bis_skin_checked="1">
                            <div data-v-f8277c96="" class="total-income" bis_skin_checked="1">
                                <div data-v-f8277c96="" class="title_box" bis_skin_checked="1">
                                    <div data-v-f8277c96="" class="title" bis_skin_checked="1">Total Return</div>
                                    <div data-v-f8277c96="" class="choose_day" bis_skin_checked="1">
              
                                    </div>
                                </div>
                                <div data-v-f8277c96="" class="info" bis_skin_checked="1">
                                    <!---->
                                    <div data-v-f8277c96="" class="img" bis_skin_checked="1">
                                        <p data-v-f8277c96="">
                                            <img data-v-f8277c96="" src="{{asset ('star/order/static/img/20260129_002445.png')}}" alt=""><span data-v-f8277c96="">No data yet</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div data-v-d3b30c6c="" data-v-f8277c96="" bis_skin_checked="1">
                            <!---->
                        </div>
                    </div>
                </div>
            ...
            <div data-v-37526a6c="" class="footer" bis_skin_checked="1">
                <div data-v-6c4d8baa="" data-v-14275b54="" class="footers" data-v-37526a6c="" bis_skin_checked="1">
                    ...
                    <div data-v-6c4d8baa="" class="item" bis_skin_checked="1"onclick="window.location.href='{{route ('ordered')}}'" >
                        <div data-v-6c4d8baa="" class="on" bis_skin_checked="1">
                            <img data-v-6c4d8baa="" src="{{asset ('star/dash/upload/v1/20260124_162628.png')}}" alt=""><span data-v-6c4d8baa="">Assets</span>
                        </div>
                    </div>
