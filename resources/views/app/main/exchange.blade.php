    ...
    *{
    ...
    <style type="text/css">
        ...
        .exchange .manage[data-v-921f994c] {
            ...
            position: relative;
            height: 100%;
            background: url({{asset ('star/bg.jpeg')}}) top/cover no-repeat
        }
...
.butto {
  ...
  font-size: 16px;
                        ...
                        <uni-view data-v-921f994c=""  style="   background-image: linear-gradient(#b7f2f2, #341150);"    class="exchange-btn butto"  onclick="toClient()">Get Gift</uni-view>
                    </uni-view>
                </uni-view>
            </uni-page-body>
        </uni-page-wrapper>
