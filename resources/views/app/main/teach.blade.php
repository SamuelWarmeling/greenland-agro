...
*/
    ...
    <style type="text/css">
        ...
        .my-head .avatar[data-v-5eb5f75c] {
            width: 1.32rem;
            height: 1.32rem;
            background: url({{Asset ('star/teach/static/img/bg-avatar.82eba0fb.png')}}) no-repeat;
            background-size: 100% 100%;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .my-head .avatar[data-v-5eb5f75c]:before {
            ...
            width: 3.6rem;
            height: .6rem;
            background: url({{Asset ('star/teach/static/img/bg-WavyLines.b341f9e1.png')}}) no-repeat;
            background-size: 100% 100%;
            position: absolute;
            top: .4rem;
            left: 50%;
    ...
    <style type="text/css">
        ...
        .my-navs .nav[data-v-1f0d3d2c] {
            ...
            display: flex;
            flex-direction: column;
            background: url({{Asset ('star/teach/static/img/bg-navs.09e271a2.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: .4rem .32rem;
        }
    ...
    <style type="text/css">
        .heads[data-v-7a3d5949] {
            padding: 0.28rem 0;
            background: url({{Asset ('star/teach/static/img/bg_my.9fbfe6c2.png')}}) no-repeat 0 -1rem;
        ...
        .g1[data-v-7a3d5949] {
            background: url({{Asset ('star/teach/static/img/bg_banner.b3f69096.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            margin-top: 0.32rem;
        }
        ...
        .g1 .flex .level-btn[data-v-7a3d5949] {
            font-size: 0.24rem;
            background: url({{Asset ('star/teach/static/img/bg-min-btn.5cfb3e60.png')}}) no-repeat;
            background-size: 100% 100%;
            border-radius: 1.8rem;
        ...
        .line .module[data-v-7a3d5949] {
            ...
            background: url({{Asset ('star/teach/static/img/bg-list.ebe69d90.png')}}) no-repeat;
            background-size: 100% 100%;
        }
        ...
        .btn-list .btn-quit[data-v-7a3d5949] {
            background: url({{Asset ('star/teach/static/img/tabbg.28cb0f3a.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .page[data-v-37526a6c] {
            min-height: 100vh;
            background: #000 url({{Asset ('star/teach/static/img/bg-default.7654c155.png')}}) no-repeat;
            background-size: 100% auto;
        }
  ...
  */
    ...
    <style type="text/css">
        ...
        .popup_box .popup-content-head[data-v-75ed67aa] {
            ...
            width: 100%;
            height: 2.6rem;
            background-image: url({{Asset ('star/teach/static/img/home_popup_top_bg.8bed63d3.png')}});
            background-size: 100% 100%;
            background-repeat: no-repeat;
    ...
    <style type="text/css">
        .card-con[data-v-0cd9ae3e] {
            ...
            margin: .4rem 0 .54rem;
            display: flex;
            background: url({{Asset ('star/teach/static/img/invitebg.cdfe3b13.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .home-video[data-v-bda0bfee] {
            ...
            background: url({{Asset ('star/teach/static/img/bg-video.9e4c14b7.png')}}) no-repeat;
            background-size: 100% 100%;
            position: relative;
        }
    ...
    <style type="text/css">
        .market-item[data-v-4d062292] {
            width: calc(48%);
            padding: .32rem .28rem;
            background: url({{Asset ('star/teach/static/img/bg-market-item.ade5668a.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .bg[data-v-5954443c] {
            background: #000 url({{Asset ('star/teach/static/img/bg-home.a6c7beab.png')}}) no-repeat;
            background-size: 100% auto;
            width: 100%;
            height: 100%;
        }
        ...
        .home-introduce .introduce-info[data-v-5954443c] {
            flex: 1;
            padding: .36rem .32rem;
            background: url({{Asset ('star/teach/static/img/jieshaobg.663a51d7.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
        ...
        .home-notice[data-v-5954443c] {
            position: relative;
            margin-top: 0.19802rem;
            background: url({{Asset ('star/teach/static/img/linebg.eec555f4.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
        ...
        .itemBox2[data-v-5954443c] {
            ...
            background: url({{Asset ('star/teach/static/img/partnerbg.9e4c14b7.png')}}) center no-repeat;
            background-size: 100% 100%;
            margin-bottom: 0.4rem;
            color: #ffffff;
        }
    ...
    <style type="text/css">
        ...
        .level-box[data-v-55daada6] {
            background: url({{Asset ('star/teach/static/img/bg-level.48bb2282.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            display: flex;
        }
    ...
    <script charset="utf-8" src="/js1746822786498/63.3f46acd1.1746822786498.chunk.js?v=1746822786498"></script>
    <style type="text/css">
        .container[data-v-6b354bc2] {
            padding-top: .24rem;
        }

        .item[data-v-6b354bc2] {
            border-radius: .24rem;
            border: 0.02rem solid rgba(255, 255, 255, 0.2);
            background: rgba(0, 0, 0, 0.1);
            box-shadow: 0 0 0.32rem 0 rgba(255, 255, 255, 0.32) inset;
        ...
        .item .top img[data-v-6b354bc2] {
            width: .32rem;
            height: auto;
            margin-right: .12rem;
        }

        .item .bot[data-v-6b354bc2] {
            display: flex;
            align-items: center;
            justify-content: space-between;
        }

        .item .bot span[data-v-6b354bc2] {
            display: block;
            flex: 1;
            color: #FFF;
            font-family: "PingFang SC";
    ...
    <style type="text/css">
        .com-btn[data-v-15bafa7f] {
            ...
            align-items: center;
            justify-content: center;
            background: url({{Asset ('star/teach/static/img/bg-btn.43aa1b59.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            font-size: .32rem;
        }
    ...
    <script charset="utf-8" src="/js1746822786498/15.460d7326.1746822786498.chunk.js?v=1746822786498"></script>
    <style type="text/css">
    ...
    <style type="text/css">
        .item[data-v-7ef1dd24] {
            margin-bottom: 0.32rem;
        }

        .item-tips[data-v-7ef1dd24] {
            color: red;
            font-size: 0.26rem;
        }

        .valMob-box[data-v-7ef1dd24] {
            position: relative;
        }

        .container[data-v-7ef1dd24] {
            margin-top: 0.32rem;
        }
        ...
        .go .xy[data-v-7ef1dd24] {
            padding: 0.1rem 0;
        }

        .go .xy .c1[data-v-7ef1dd24] {
            color: #2add84;
        }

        .go p[data-v-7ef1dd24] {
            margin-top: 0.2rem;
            color: #fff;
            font-size: 0.26rem;
            text-align: center;
    ...
    <script charset="utf-8" src="/js1746822786498/74.400f79d7.1746822786498.chunk.js?v=1746822786498"></script>
    <style type="text/css">
        .item[data-v-3996854c] {
            margin-top: .2rem;
            padding-bottom: .1rem;
        }
...
<body __processed_d177660a-3d5a-4a82-945b-17b4f4297e3c__="true" class="w856"
    ...
    <div id="app" class="applang" bis_skin_checked="1">
        <div data-v-37526a6c="" data-v-3996854c="" class="page" bis_skin_checked="1">
            <div data-v-37526a6c="" class="headers" bis_skin_checked="1">
                <div data-v-0ff1fb10="" data-v-3996854c="" class="head on" data-v-37526a6c="" bis_skin_checked="1">
                    <div data-v-0ff1fb10="" class="container flex" bis_skin_checked="1">
                        <div data-v-0ff1fb10="" class="back" bis_skin_checked="1" onclick="window.location.href='{{route ('dashboard')}}'"><img data-v-0ff1fb10="" src="{{Asset ('star/teach/static/img/ico_back.ceeff0ae.png')}}" alt="">
                        </div>
                        <!---->
            ...
            <div data-v-37526a6c="" id="scroll" class="content-container" style="padding-top: 52px;"
                bis_skin_checked="1">
                <div data-v-37526a6c="" id="content" class="content-scroll" bis_skin_checked="1">
                    <div data-v-3996854c="" data-v-37526a6c="" class="container" bis_skin_checked="1">
                        <div data-v-3996854c="" data-v-37526a6c="" class="item" bis_skin_checked="1">
                            <h2 data-v-3996854c="" data-v-37526a6c="">Teaching Class </h2>
                            <div data-v-3996854c="" data-v-37526a6c="" class="p" bis_skin_checked="1">
                                <div class="ckeditor-html5-video" data-responsive="true" style="text-align:center"
                                    bis_skin_checked="1">
                                    <video controls="controls"
                                        poster="{{asset ('star/teach/upload/20250210/2041795ae0434c961a06e8cbfecdaaa9.jpg')}}"
                                        src="{{asset ('star/teach/upload/20250210/39b95d08d509b98b0ff2d8ad2883de15.mp4')}}"
                                        style="height:auto; max-width:100%">&nbsp;</video>
                                </div>

                                <p>1：SF Recharge Tutorial</p>

                                <div class="ckeditor-html5-video" data-responsive="true" style="text-align:center"
                                    bis_skin_checked="1">
                                    <video controls="controls"
                                        poster="{{asset ('star/teach/upload/20250210/d4fc8f550e4ffb60724959be43022f54.jpg')}}"
                                        src="{{asset ('star/teach/upload/20250210/9ba1e2d5573e5ccc28082cbc0a98f5ae.mp4')}}"
                                        style="height:auto; max-width:100%">&nbsp;</video>
                                </div>

                                <p>2：SF Invitation Tutorial</p>

                                <div class="ckeditor-html5-video" data-responsive="true" style="text-align:center"
                                    bis_skin_checked="1">
                                    <video controls="controls"
                                        poster="{{asset ('star/teach/upload/20250210/393fa6ab20d22a85305225bfcbcb0d12.jpg')}}"
                                        src="{{asset ('star/teach/upload/20250210/5733cea5a1b079bf302ec8cfefeceaf2.mp4')}}"
                                        style="height:auto; max-width:100%">&nbsp;</video>
                                </div>

                                <p>3：SF Registration Tutorial</p>

                                <div class="ckeditor-html5-video" data-responsive="true" style="text-align:center"
                                    bis_skin_checked="1">
                                    <video controls="controls"
                                        poster="{{asset ('star/teach/upload/20250210/0454b0652f9458a7f1537d08aec62ceb.jpg')}}"
                                        src="{{asset ('star/teach/upload/20250210/1b3101cf2faa4419e2a39d9284858ded.mp4')}}"
                                        style="height:auto; max-width:100%">&nbsp;</video>
                                </div>

                                <p>4：SF Withdrawal Tutorial</p>

                                <div class="ckeditor-html5-video" data-responsive="true" style="text-align:center"
                                    bis_skin_checked="1">
                                    <video controls="controls"
                                        poster="{{asset ('star/teach/upload/20250419/20ebd87f0401d4a90ff95ac65969329f.jpg')}}"
                                        src="{{asset ('star/teach/mp4/SF%E7%BB%91%E5%AE%9A%E8%B0%B7%E6%AD%8C%E6%95%99%E7%A8%8B_20250419_23284398.mp4')}}"
                                        style="height:auto; max-width:100%">&nbsp;</video>
                                </div>

                                <p>5:SF Binding Google Tutorial</p>

                                <div class="ckeditor-html5-video" data-responsive="true" style="text-align:center"
                                    bis_skin_checked="1">
                                    <video controls="controls"
                                        poster="{{asset ('star/teach/upload/20250419/e358868ec8a46b028422e021c7b10211.jpg')}}"
                                        src="{{asset ('star/teach/mp4/sf.mp4')}}"
                                        style="height:auto; max-width:100%">&nbsp;</video>
                                </div>

                                <p>6:SF Identity Authentication Tutorial</p>

                                <div class="ckeditor-html5-video" data-responsive="true" style="text-align:center"
                                    bis_skin_checked="1">
                                    <video controls="controls"
                                        poster="{{asset ('star/teach/upload/20250423/937b084114d453fd5c563d7b1e379d0c.jpg')}}"
                                        src="{{asset ('star/teach/mp4/SF%E6%AF%8F%E6%97%A5%E4%BB%BB%E5%8A%A1%E6%95%99%E7%A8%8B.mp4')}}"
                                        style="height:auto; max-width:100%">&nbsp;</video>
                                </div>

                                <p>7:SF Daily Quantitative Task Tutorial</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="van-toast van-toast--middle van-toast--text" style="z-index: 2003; display: none;" bis_skin_checked="1">
