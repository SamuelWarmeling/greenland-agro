  ...
  */
    ...
    <style type="text/css">
        ...
        .popup_box .popup-content-head[data-v-75ed67aa] {
            ...
            width: 100%;
            height: 2.6rem;
            background-image: url({{asset ('star/pass/static/img/home_popup_top_bg.8bed63d3.png')}});
            background-size: 100% 100%;
            background-repeat: no-repeat;
    ...
    <style type="text/css">
        .card-con[data-v-0cd9ae3e] {
            ...
            margin: .4rem 0 .54rem;
            display: flex;
            background: url({{asset ('star/pass/static/img/invitebg.cdfe3b13.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .home-video[data-v-bda0bfee] {
            ...
            background: url({{asset ('star/pass/static/img/bg-video.9e4c14b7.png')}}) no-repeat;
            background-size: 100% 100%;
            position: relative;
        }
    ...
    <style type="text/css">
        .market-item[data-v-4d062292] {
            width: calc(48%);
            padding: .32rem .28rem;
            background: url({{asset ('star/pass/static/img/bg-market-item.ade5668a.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .bg[data-v-5954443c] {
            background: #000 url({{asset ('star/pass/static/img/bg-home.a6c7beab.png')}}) no-repeat;
        ...
        .home-introduce .introduce-info[data-v-5954443c] {
            flex: 1;
            padding: .36rem .32rem;
            background: url({{asset ('star/pass/static/img/jieshaobg.663a51d7.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
        ...
        .home-notice[data-v-5954443c] {
            position: relative;
            margin-top: 0.19802rem;
            background: url({{asset ('star/pass/static/img/linebg.eec555f4.png')}}) center no-repeat;
            background-size: 100% 100%;
        }
        ...
        .name-1 .tab .active[data-v-5954443c] {
            background: url({{asset ('star/pass/static/img/tabbg.28cb0f3a.png')}}) center no-repeat;
            background-size: 100% 100%;
            color: #fff;
        }
        ...
        .itemBox2[data-v-5954443c] {
            ...
            background: url({{asset ('star/pass/static/img/partnerbg.9e4c14b7.png')}}) center no-repeat;
            background-size: 100% 100%;
            margin-bottom: 0.4rem;
            color: #ffffff;
        }
    ...
    <style type="text/css">
        .page[data-v-37526a6c] {
            min-height: 100vh;
            background: #000 url({{asset ('star/pass/static/img/bg-default.7654c155.png')}}) no-repeat;
            background-size: 100% auto;
        }
    ...
    <style type="text/css">
        ...
        .level-box[data-v-55daada6] {
            background: url({{asset ('star/pass/static/img/bg-level.48bb2282.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            display: flex;
        }
    ...
    <style type="text/css">
        ...
        .total-income[data-v-f8277c96] {
            margin-top: .2rem;
            overflow: hidden;
            background: url({{asset ('star/pass/static/img/bg-chart.aa2ec508.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .wallet-assets .assets-list[data-v-8bfe4f4e] {
            ...
            flex-wrap: wrap;
            padding: .32rem 0;
            background: url({{asset ('star/pass/static/img/bg-wallet-assets.e9aa4a59.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .income_box[data-v-14275b54] {
            padding: .28rem;
            background: url({{asset ('star/pass/static/img/home-wallet-bg.8a119ff6.png')}}) no-repeat top center;
            background-size: 100% 100%;
            border-radius: .16rem;
        }
    ...
    <style type="text/css">
        .grid-banner[data-v-5f02d15c] {
            ...
            align-items: center;
            line-height: 1.2;
            background: url({{asset ('star/pass/static/img/bg-banner.66e8bfef.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .grid-info .level-con[data-v-a156a844] {
            ...
            justify-content: center;
            flex-direction: column;
            background: url({{asset ('star/pass/static/img/bg-grid-info-left.9ab0bdb4.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: .24rem .32rem;
        }
        ...
        .grid-info .info-right[data-v-a156a844] {
            ...
            padding: .28rem;
            text-align: center;
            background: url({{asset ('star/pass/static/img/bg-grid-info-right.a37bece4.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        [data-v-e157743a] .headers {
            background: url({{asset ('star/pass/static/img/bg-home.a6c7beab.png')}}) no-repeat top center !important;
    ...
    <style type="text/css">
        ...
        .grid-trad .trad-left[data-v-ea03dd80] {
            ...
            justify-content: center;
            flex-direction: column;
            background: url({{asset ('star/pass/static/img/bg-trad-left.975f1e9d.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: .24rem .32rem;
        }
        ...
        .grid-trad .trad-right .grid-btn[data-v-ea03dd80] {
            ...
            font-size: .24rem;
            padding: 0.07921rem;
            background: url({{asset ('star/pass/static/img/bg-grid-btn.dc03b59b.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    </style>
    <style type="text/css">
        .grid-level[data-v-481208f5] {
            ...
            background: url({{asset ('star/pass/static/img/bg-grid-card.f68af2cd.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .popup-box .content .grid-level-list .grid-level-item.active[data-v-d0256664] {
            border: none;
            background: url({{asset ('star/pass/static/img/bg-grid-level-active.3f9197b3.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .assets-list[data-v-0549ce35] {
            ...
            flex-wrap: wrap;
            padding: 0.4rem;
            background: url({{asset ('star/pass/static/img/bg-assets.786bee5d.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        .quantify-level[data-v-15212f42] {
            ...
            background: url({{asset ('star/pass/static/img/bg-quantify-level.3c28e742.png')}}) no-repeat;
            background-size: 100% 100%;
            display: flex;
            align-items: center;
            justify-content: space-between;
    ...
    <style type="text/css">
        ...
        .trading-btn[data-v-4681035b] {
            ...
            align-items: center;
            justify-content: center;
            background: url({{asset ('star/pass/static/img/bg-btn.43aa1b59.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            font-size: 0.32rem;
            text-align: center;
    ...
    <style type="text/css">
        .assets-list[data-v-38c37e3e] {
            padding: .4rem .28rem;
            background: url({{asset ('star/pass/static/img/bg-asstes-card.ce8df5cb.png')}}) no-repeat;
            background-size: 100% 100%;
            display: flex;
            align-items: center;
            flex-wrap: wrap;
    ...
    <style type="text/css">
        ...
        .my-head .avatar[data-v-5eb5f75c] {
            width: 1.32rem;
            height: 1.32rem;
            background: url({{asset ('star/pass/static/img/bg-avatar.82eba0fb.png')}}) no-repeat;
            background-size: 100% 100%;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .my-head .avatar[data-v-5eb5f75c]:before {
            ...
            width: 3.6rem;
            height: .6rem;
            background: url({{asset ('star/pass/static/img/bg-WavyLines.b341f9e1.png')}}) no-repeat;
            background-size: 100% 100%;
            position: absolute;
            top: .4rem;
            left: 50%;
    ...
    <style type="text/css">
        ...
        .my-navs .nav[data-v-1f0d3d2c] {
            ...
            display: flex;
            flex-direction: column;
            background: url({{asset ('star/pass/static/img/bg-navs.09e271a2.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: .4rem .32rem;
        }
    ...
    <style type="text/css">
        .heads[data-v-7a3d5949] {
            padding: 0.28rem 0;
            background: url({{asset ('star/pass/static/img/bg_my.9fbfe6c2.png')}}) no-repeat 0 -1rem;
            background-size: 100% auto;
        }
        ...
        .g1[data-v-7a3d5949] {
            background: url({{asset ('star/pass/static/img/bg_banner.b3f69096.png')}}) no-repeat;
            background-size: 100% 100%;
            color: #fff;
            margin-top: 0.32rem;
        }
        ...
        .g1 .flex .level-btn[data-v-7a3d5949] {
            font-size: 0.24rem;
            background: url({{asset ('star/pass/static/img/bg-min-btn.5cfb3e60.png')}}) no-repeat;
            background-size: 100% 100%;
            border-radius: 1.8rem;
        ...
        .line .module[data-v-7a3d5949] {
            ...
            background: url({{asset ('star/pass/static/img/bg-list.ebe69d90.png')}}) no-repeat;
            background-size: 100% 100%;
        }
    ...
    <style type="text/css">
        ...
        .bg[data-v-2a224bbc] {
            background: #000 url({{asset ('star/pass/static/img/bg_invite.10776553.png')}}) no-repeat;
            background-size: 100% auto;
            width: 100%;
            height: 100%;
        }
        ...
        .invite-con[data-v-2a224bbc] {
            ...
            background: url({{asset ('star/pass/static/img/bg-invite-con.0a4a121d.png')}}) no-repeat;
            background-size: 100% 100%;
            padding: 0 .32rem;
        }
        ...
        .invite-con .qrcode-box .qrcode-con[data-v-2a224bbc] {
            width: fit-content;
            padding: .32rem;
            background: url({{asset ('star/pass/static/img/bg-qrcode.79d104a8.png')}}) no-repeat;
            background-size: 100% 100%;
        }
...
<body __processed_45a1e1de-c144-4026-9a7f-7c194fe791c6__="true"
    ...
    <div id="app" class="applang" bis_skin_checked="1">
        <div data-v-37526a6c="" data-v-40856e44="" class="page" bis_skin_checked="1">
            <div data-v-37526a6c="" class="headers" bis_skin_checked="1">
                <div data-v-0ff1fb10="" data-v-40856e44="" class="head on" data-v-37526a6c="" bis_skin_checked="1">
                    <div data-v-0ff1fb10="" class="container flex" bis_skin_checked="1" onclick="window.location.href='{{route ('profile')}}'">
                        <div data-v-0ff1fb10="" class="back" bis_skin_checked="1"><img data-v-0ff1fb10="" src="{{asset ('star/pass/static/img/ico_back.ceeff0ae.png')}}" alt="">
                        </div>
                        <!---->
                        <div data-v-0ff1fb10="" class="name tac" bis_skin_checked="1"> Modify login password </div>
            ...
            <div data-v-37526a6c="" id="scroll" class="content-container" bis_skin_checked="1"
                ...
                <div data-v-37526a6c="" id="content" class="content-scroll" bis_skin_checked="1">
                    <div data-v-40856e44="" data-v-37526a6c="" class="container" bis_skin_checked="1">
                        <div data-v-40856e44="" data-v-37526a6c="" class="item valMob common" bis_skin_checked="1">
                            <div data-v-40856e44="" data-v-37526a6c="" class="cname" bis_skin_checked="1">Old password
                            </div>
                            <div data-v-40856e44="" data-v-37526a6c="" class="val inp flex" bis_skin_checked="1">
                                <div data-v-40856e44="" data-v-37526a6c="" class="flex1" bis_skin_checked="1">
                                <input data-v-40856e44="" data-v-37526a6c="" name="old_password" placeholder="Please enter a new password" type="password">
                                </div>
                                <div data-v-40856e44="" data-v-37526a6c="" class="yj" bis_skin_checked="1"><img data-v-40856e44="" data-v-37526a6c="" src="data:image/png;base64,">
                                </div>
                            </div>
                        </div>
             <div data-v-40856e44="" data-v-37526a6c="" class="item valMob common" bis_skin_checked="1">
                            <div data-v-40856e44="" data-v-37526a6c="" class="cname" bis_skin_checked="1">New password
                            </div>
                            <div data-v-40856e44="" data-v-37526a6c="" class="val inp flex" bis_skin_checked="1">
                                <div data-v-40856e44="" data-v-37526a6c="" class="flex1" bis_skin_checked="1"><input data-v-40856e44="" data-v-37526a6c=""name="new_password"  placeholder="Please enter a new password" type="password">
                                </div>
                                <div data-v-40856e44="" data-v-37526a6c="" class="yj" bis_skin_checked="1"><img data-v-40856e44="" data-v-37526a6c="" src="data:image/png;base64,">
                                </div>
                            </div>
                        ...
                        <div data-v-40856e44="" data-v-37526a6c="" class="item valMob common" bis_skin_checked="1">
                            <div data-v-40856e44="" data-v-37526a6c="" class="cname" bis_skin_checked="1">Confirm
                                password</div>
                            <div data-v-40856e44="" data-v-37526a6c="" class="inp val flex active" bis_skin_checked="1">
                                <div data-v-40856e44="" data-v-37526a6c="" class="flex1" bis_skin_checked="1"><input data-v-40856e44="" name="confirm_password" data-v-37526a6c="" placeholder="Please enter the new password again" type="password">
                                </div>
                                <div data-v-40856e44="" data-v-37526a6c="" class="yj" bis_skin_checked="1"><img data-v-40856e44="" data-v-37526a6c="" src="data:image/png;base64,">
                                </div>
                            </div>
                        </div>
                        <div data-v-40856e44="" data-v-37526a6c="" class="item tipsBox" bis_skin_checked="1">
                            <div data-v-40856e44="" data-v-37526a6c="" class="name" bis_skin_checked="1"><img data-v-40856e44="" data-v-37526a6c="" src="data:image/png;base64," alt=""> Reminder
                            </div>
                            <div data-v-40856e44="" data-v-37526a6c="" class="s" bis_skin_checked="1">To ensure the
                                security of your account, you can withdraw money only 48 hours after resetting your
                                login password</div>
                        </div>
                        <div data-v-40856e44="" data-v-37526a6c="" class="go" bis_skin_checked="1">
                            <div data-v-15bafa7f="" data-v-40856e44="" class="com-btn" data-v-37526a6c="" onclick="login()"
                                bis_skin_checked="1">OK</div>
                        </div>
                    </div>
                </div>
            </div>
